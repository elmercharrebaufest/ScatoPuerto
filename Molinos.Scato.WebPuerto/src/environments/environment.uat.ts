export const environment = {
  ...
  redirectUri: 'https://scatopuertouat.molinosagro.com.ar/Scato.WebPuerto',
  postLogoutRedirectUri: 'https://scatopuertouat.molinosagro.com.ar/Scato.WebPuerto/login',
