export const environment = {
  ...
  redirectUri: 'https://scatopuertoqa.molinosagro.com.ar/Scato.WebPuerto',
  postLogoutRedirectUri: 'https://scatopuertoqa.molinosagro.com.ar/Scato.WebPuerto/login',
  ...
  webPuertoApiPassword:'ipiYlewqesadW3QB7B'
};
