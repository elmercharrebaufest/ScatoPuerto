export const environment = {
  production: true,
  envName: 'qa2',
  apiUrl: '/QA2/Scato.WebPuertoApi/api/',
  apiAzureUrl: '/Scato.AzureAD/',
  apiGraph: 'https://graph.microsoft.com/v1.0/',
  clientIdMoa: 'ac5390bd-7225-4fe0-be95-9d2e5aa582a5',
  clientIdMoc: '5ab4c0b8-bf3b-42ef-90b9-697559762d72',
  redirectUri: 'https://scatopuertoqa.molinosagro.com.ar/QA2/Scato.WebPuerto',
  postLogoutRedirectUri: 'https://scatopuertoqa.molinosagro.com.ar/QA2/Scato.WebPuerto/login',
