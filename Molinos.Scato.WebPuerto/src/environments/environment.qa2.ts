export const environment = {
  ...
  redirectUri: 'https://scatopuertoqa2.molinosagro.com.ar/Scato.WebPuerto',
  postLogoutRedirectUri: 'https://scatopuertoqa2.molinosagro.com.ar/Scato.WebPuerto/login',
