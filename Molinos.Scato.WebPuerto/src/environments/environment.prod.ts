export const environment = {
  ...
  redirectUri: 'https://scatopuerto.molinosagro.com.ar/Scato.WebPuerto',
  postLogoutRedirectUri: 'https://scatopuerto.molinosagro.com.ar/Scato.WebPuerto/login',
  ...
  webPuertoApiPassword:'ipiYlSviabcsW3QB7B'
};
