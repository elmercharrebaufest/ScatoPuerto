...
if not exists(select 1 from PuntosInteresGeolocalizacion where Latitud = '-35.61958  ' and Longitud='-55.88947') BEGIN insert into PuntosInteresGeolocalizacion (Nombre, TipoUbicacion, Imagen,Puerto, Pais, HorasSanBenito, Latitud, Longitud, DistanciaKM, TipoZona, AgrupadorZona, PosicionZona, RadioPunto, Estado, FechaRegistro) values('Recalada','Fondeadero','ancla','','AR','30','-35.61958  ','-55.88947',5,'','','',100000,1,getdate()) END
if not exists(select 1 from PuntosInteresGeolocalizacion where Latitud = '-35.04461  ' and Longitud='-56.05877') BEGIN insert into PuntosInteresGeolocalizacion (Nombre, TipoUbicacion, Imagen,Puerto, Pais, HorasSanBenito, Latitud, Longitud, DistanciaKM, TipoZona, AgrupadorZona, PosicionZona, RadioPunto, Estado, FechaRegistro) values('Recalada','Fondeadero','ancla','','UR','30','-35.04461  ','-56.05877',5,'','','',100000,1,getdate()) END
...
if not exists(select 1 from PuntosInteresGeolocalizacion where Latitud = '-32.56767762941911 ' and Longitud='-60.73236436084971') BEGIN insert into PuntosInteresGeolocalizacion (Nombre, TipoUbicacion, Imagen,Puerto, Pais, HorasSanBenito, Latitud, Longitud, DistanciaKM, TipoZona, AgrupadorZona, PosicionZona, RadioPunto, Estado, FechaRegistro) values('Zona 02','Zona','','','','0','-32.56767762941911 ','-60.73236436084971',0,'Cuadrado','Zona San Benito','1',0,1,getdate()) END
if not exists(select 1 from PuntosInteresGeolocalizacion where Latitud = '-32.578881501707684' and Longitud='-60.78554497297118') BEGIN insert into PuntosInteresGeolocalizacion (Nombre, TipoUbicacion, Imagen,Puerto, Pais, HorasSanBenito, Latitud, Longitud, DistanciaKM, TipoZona, AgrupadorZona, PosicionZona, RadioPunto, Estado, FechaRegistro) values('Zona 02','Zona','','','','0','-32.578881501707684','-60.78554497297118',0,'Cuadrado','Zona San Benito','2',0,1,getdate()) END
if not exists(select 1 from PuntosInteresGeolocalizacion where Latitud = '-32.810044421311005' and Longitud='-60.70848960825942') BEGIN insert into PuntosInteresGeolocalizacion (Nombre, TipoUbicacion, Imagen,Puerto, Pais, HorasSanBenito, Latitud, Longitud, DistanciaKM, TipoZona, AgrupadorZona, PosicionZona, RadioPunto, Estado, FechaRegistro) values('Zona 02','Zona','','','','0','-32.810044421311005','-60.70848960825942',0,'Cuadrado','Zona San Benito','3',0,1,getdate()) END
if not exists(select 1 from PuntosInteresGeolocalizacion where Latitud = '-32.7987566445919  ' and Longitud='-60.65799492589506') BEGIN insert into PuntosInteresGeolocalizacion (Nombre, TipoUbicacion, Imagen,Puerto, Pais, HorasSanBenito, Latitud, Longitud, DistanciaKM, TipoZona, AgrupadorZona, PosicionZona, RadioPunto, Estado, FechaRegistro) values('Zona 02','Zona','','','','0','-32.7987566445919  ','-60.65799492589506',0,'Cuadrado','Zona San Benito','4',0,1,getdate()) END
