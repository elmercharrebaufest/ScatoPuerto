...
IF NOT EXISTS (select 1 from TipoDocumentoIdentidad where descripcionCorta = 'LE') BEGIN insert into TipoDocumentoIdentidad (Descripcion,DescripcionCorta, CodiSap) values ('Libreta de Enrolamiento','LE', '12'); END
IF NOT EXISTS (select 1 from TipoDocumentoIdentidad where descripcionCorta = 'CI') BEGIN insert into TipoDocumentoIdentidad (Descripcion,DescripcionCorta, CodiSap) values ('Cédula de Identidad','CI', '00'); END
IF NOT EXISTS (select 1 from TipoDocumentoIdentidad where descripcionCorta = 'PP') BEGIN insert into TipoDocumentoIdentidad (Descripcion,DescripcionCorta, CodiSap) values ('Pasaporte','PP', '13'); END
...
-- Permisos
IF NOT EXISTS (select 1 from Permiso where Codi = 1) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Tipo Documento Identidad',0 , 1, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 2) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Material',0 , 2, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 3) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Chofer',0 , 3, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 4) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Almacen',0 , 4, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 5) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Transportista',0 , 5, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 6) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Excepcion Al Control',0 , 6, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 7) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Inhabilitacion Chofer',0 , 7, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 8) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Inhabilitacion Camion',0 , 8, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 9) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Centro',0 , 9, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 10) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Tipo Comercial',0 , 10, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 11) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Tipo Comercial Por Wf',0 , 11, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 12) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Balanza',0 , 12, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 13) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Caracteristica De Calidad',0 , 13, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 14) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Camara',0 , 14, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 15) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Motivo',0 , 15, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 16) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Boca Destino',0 , 16, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 17) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Humedímetro',0 , 17, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 18) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Rol',0 , 18, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 19) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Permiso',0 , 19, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 20) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Usuario',0 , 20, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 21) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Suplencia',0 , 21, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 22) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Excepción de Envío a Cámara',0 , 22, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 23) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Entregador',0 , 23, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 24) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Transaccion SAP',0 , 24, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 25) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Material Por Workflow',0 , 25, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 26) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Panel De Control Transacciones Sap', 0, 26, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 27) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Tara Romaneo', 0, 27, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 28) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Talonario', 0, 28, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 29) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Modificar Documento de Ingreso', 0, 29, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 30) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Reimprimir Documento', 0, 30, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 31) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Exportación de Archivos para AFIP', 0, 31, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 32) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Proveedor', 0, 32, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 33) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Impresiones', 0, 33, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 34) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Formato de Impresion', 0, 34, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 35) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Libro de Movimientos y Existencia de Granos', 0, 35, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 36) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Borrado de Documento', 0, 36, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 37) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Tara Contenedor', 0, 37, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 38) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Calle', 0, 38, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 39) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Calidades Por Material', 0, 39, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 40) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Casillero', 0, 40, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 41) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Tarjetas Bloqueadas', 0, 41, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 42) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Recibo Municipal', 0, 42, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 43) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Tarjetas Ran', 0, 43, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 44) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Tarjetas Supervisor', 0, 44, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 45) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Hidraulica', 0, 45, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 46) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Controles de Tiempo', 0, 46, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 47) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Puestos de Trabajo', 0, 47, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 48) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Actividad Por Dispositivos', 0, 48, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 49) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Actividad Por Barrera Semaforo', 0, 49, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 50) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Motivo de Quiebre de Barrera', 0, 50, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 51) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Editor de Workflow', 0, 51, 'Editor de Workflow'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 52) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Consultar Documento de Ingreso', 0, 52, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 53) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Lista de Tareas Automatizada', 0, 53, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 54) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Modalidad Puesto de Trabajo', 0, 54, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 55) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reimpresion de Documentos Imprimir Documento', 0, 55, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 56) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reimpresion de Documentos Borrar Documento', 0, 56, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 57) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Liberacion de Casilleros', 0, 57, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 58) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Consulta de Casilleros', 0, 58, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 59) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Impresión', 0, 59, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 60) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Exportación de Archivos', 0, 60, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 61) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM CIU Anulados', 0, 61, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 62) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Viñedo Propio', 0, 62, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 63) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Variedad por Vinedo', 0, 63, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 64) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Viñedo de Terceros', 0, 64, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 65) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Asignación de Recorrido', 0, 65, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 66) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Exportación de archivos para CIU', 0, 66, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 67) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Actividad con Carga Automática', 0, 67, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 68) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Establecimientos', 0, 68, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 69) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Consultar Documento por Tarjeta', 0, 69, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 70) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Empresa', 0, 70, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 71) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Tecnologia', 0, 71, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 72) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Proveedor Exceptuado del Sistema Industria', 0, 72, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 73) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Transmisión a sap', 0, 73, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 74) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Impresion Por Centro', 0, 74, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 75) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Borrar Impresion Por Centro', 0, 75, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 76) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Panel de Control Transacciones Cupos', 0, 76, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 77) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Movimiento De Bines', 0, 77, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 78) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Firma', 0, 78, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 79) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Excepción al Descuento', 0, 79, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 80) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Administración de Distancias', 0, 80, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 81) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Borrar Documentos Terminados', 0, 81, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 82) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Borrar Documentos No Terminados', 0, 82, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 83) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Tipos de Vehículos', 0, 83, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 84) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Stock de Establecimiento', 0, 84, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 85) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Cosecha', 0, 85, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 86) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Cateria', 0, 86, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 87) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Matricula', 0, 87, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 88) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Envio Camara Directo', 0, 88, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 89) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Aviso de Quiebre', 0, 89, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 90) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Abm Nirs',0 , 90, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 91) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Historico de Camiones',0 , 91, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 92) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Estación Meteorológica', 0, 92, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 93) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Habilitación De Vehiculos', 0, 93, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 94) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Analisis Obligatorio', 0, 94, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 95) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Regla De Analisis Obligatorio', 0, 95, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 96) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puesto de Comando Calado en Planta', 0, 96, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 97) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ABM Cliente', 0, 97, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 98) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Transmision A Sap Manual', 0, 98, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 99) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('CP Otros Puertos', 0, 99, NULL); END

IF NOT EXISTS (select 1 from Permiso where Codi = 100) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Autorizar Descuentos Entregador', 1, 100, 'AutorizarDescuentosEntregador'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 101) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Autorizar Transportista Inhabilitado', 1, 101, 'AutorizarTransportistaInhabilitado'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 102) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Balanza A Cero', 1, 102, 'BalanzaACero'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 103) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Calado', 1, 103, 'Calado'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 104) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Cargar Precintos', 1, 104, 'CargarPrecintos'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 105) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Control De Peso Esperado', 1, 105, 'ControlDePesoEsperado'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 106) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Control Peso Maximo', 1, 106, 'ControlPesoMaximo'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 107) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Coordinacion', 1, 107, 'Coordinacion'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 108) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Documento De Ingreso', 1, 108, 'DocumentoDeIngreso'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 109) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresar Orden Carga Interna', 1, 109, 'IngresarOrdenCargaInterna'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 110) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingreso De Observaciones', 1, 110, 'IngresoDeObservaciones'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 111) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Lista De Camiones', 1, 111, 'ListaDeCamiones'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 112) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Pesada', 1, 112, 'Pesada'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 113) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Salida De Centro', 1, 113, 'SalidaDeCentro'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 114) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Verificacion Camion Rechazado', 1, 114, 'VerificacionCamionRechazado'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 115) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Cargar Carta Porte', 1, 115, 'CargarCartaPorte'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 116) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingreso De Transportista', 1, 116, 'IngresoDeTransportista'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 117) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Baja De CTG', 1, 117, 'BajaCTG'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 118) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Confirmacion De Carga/Descarga', 1, 118, 'ConfirmacionDeCargaDescarga'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 119) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Analisis De Calidad', 1, 119, 'AnalisisDeCalidad'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 120) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Control de Peso Origen', 1, 120, 'ControlPesoOrigen'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 121) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresar Carta de Porte Por Redespacho', 1, 121, 'IngresarCartaPorteRedespacho'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 122) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Alta De CTG', 1, 122, 'AltaCTG'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 123) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Movimiento Stock', 1, 123, 'ServicioSapMovAjuste'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 124) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Existe Pedido De Traslado', 1, 124, 'ExistePedidoDeTraslado'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 125) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Salida De Origen En Redespacho', 1, 125, 'ServicioSapMov975'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 126) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Llegada A Destino En Redespacho', 1, 126, 'ServicioSapMov305'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 127) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingreso Por Compra De Granos', 1, 127, 'ServicioSapFill_Z1000'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 128) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Control Peso Neto', 1, 128, 'ControlPesoNeto'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 129) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Cargar Orden De Descarga', 1, 129, 'CargarOrdenDeDescarga'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 130) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresar Orden Carga Fas', 1, 130, 'IngresarOrdenCargaFas'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 131) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Romaneo', 1, 131, 'Romaneo'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 132) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Visteo', 1, 132, 'Visteo'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 133) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Egreso de Material no Productivo', 1, 133, 'ServicioSapEgresosNoProductivos'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 134) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingreso De Lote', 1, 134, 'IngresoDeLote'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 135) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Verificacion COT', 1, 135, 'VerificacionCot'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 136) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Validar Contrato', 1, 136, 'ValidarContrato'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 137) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresar CP Redespacho Prestamo', 1, 137, 'IngresarCartaPorteRedespachoPrestamo'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 138) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresar CP Prestamo', 1, 138, 'CargarCartaPortePrestamo'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 139) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresar Orden de Descarga (Fason)', 1, 139, 'CargarOrdenDeDescargaFason'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 140) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresar Orden de Carga Interna (Fason)', 1, 140, 'IngresarOrdenCargaInternaFason'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 141) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Baja CTG Definitivo', 1, 141, 'BajaCTGDefinitivo'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 142) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Control de Ingreso', 1, 142, 'ControlDeIngreso'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 143) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresos Egresos Fazones', 1, 143, 'ServicioSapIngresosEgresosFazones'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 144) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Verifiacion Salida Flete', 1, 144, 'VerificacionSalidaFlete'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 145) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Pesa Neto', 1, 145, 'ServicioSapPesaNeto'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 146) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresar Carta Porte Egreso por Desvio', 1, 146, 'CargarCartaPorteRedespachoDesvio'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 147) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingreso Número de COT', 1, 147, 'IngresoNumeroCot'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 148) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Fletes Doble Tramo', 1, 148, 'ServicioSap_Z4030'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 149) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Cargar Remito entre Plantas', 1, 149, 'CargarOrdenEntrePlantas'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 150) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ingreso Remito', 1, 150, 'IngresoRemito'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 151) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Descarga Unidad', 1, 151, 'ControlPesoNetoDescargaUnidad'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 152) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Control Peso Neto Descarga Unidad', 1, 152, 'DescargaUnidad'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 153) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Cargar Orden de Carga por Contenedor', 1, 153, 'CargarOrdenDeCargaContenedor'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 154) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ingreso Remito Terceros', 1, 154, 'IngresoRemitoTerceros'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 155) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Cargar Carta Porte Fasón', 1, 155, 'CargarCartaPorteFason'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 156) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Autorizar Tiempo En Tránsito', 1, 156, 'AutorizarTiempoEnTransito'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 157) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Imprime Recibo Municipal', 1, 157, 'ImprimeReciboMunicipal'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 158) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puesto Comando', 1, 158, 'PuestoComando'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 159) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Control de Balanza', 1, 159, 'ControlDeBalanza'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 160) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Indianápolis', 1, 160, 'EnEsperaIndianapolis'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 161) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('En Espera Aduana', 1, 161, 'EnEsperaAduana'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 162) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Pesada Tara', 1, 162, 'PesadaTara'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 163) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Pesada Bruto', 1, 163, 'PesadaBruto'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 164) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad En Playa Externa', 1, 164, 'EnPlayaExterna'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 165) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad En Tránsito', 1, 165, 'EnTransito'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 166) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Egreso Sin Flete Fasones', 1, 166, 'ServicioSapMov291'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 167) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingreso CIU', 1, 167, 'IngresoCIU'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 168) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Remito Bodega Uva Propia', 1, 168, 'RemitoBodegaUvaPropia'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 169) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Autorizar Recepción de Uvas', 1, 169, 'AutorizarRecepcionUvas'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 170) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Distribución de almacenes', 1, 170, 'DistribucionDeAlmacenes'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 171) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingreso Bins de Salida', 1, 171, 'IngresoBinSalida'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 172) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Remito Bodega Uva Terceros', 1, 172, 'RemitoBodegaUvaTerceros'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 173) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Cargar Hoja de Ruta', 1, 173, 'CargarHojaDeRuta'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 174) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Cargar Hoja de Ruta Yerbatera', 1, 174, 'CargarHojaDeRutaYerbatera'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 175) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Asignacion de Establecimiento', 1, 175, 'AsignacionDeEstablecimiento'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 176) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Pesada Bruto Vagón', 1, 176, 'PesadaBrutoVan'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 177) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Pesada Tara Vagón', 1, 177, 'PesadaTaraVan'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 178) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Remito Bodega Vino',1,178,'RemitoBodegaVino'); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 179) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Verificar Impresión',1,179,'VerificarImpresion'); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 180) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Ingresos Bodega',1,180,'ServicioSapIngresosBodega'); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 181) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Forzar Cero',1,181,null); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 182) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Generar Archivo de Movimientos',1,182,null); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 183) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ingreso de Datos de Exportación',1,183,'IngresoDeDatosDeExportacion'); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 184) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Carga de Cupo',1,184,'CargaDeCupo'); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 185) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ingresar Carta Porte Redespacho Importaciones',1,185,'IngresarCartaPorteRedespachoImportaciones'); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 186) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Servicio Sap ZE7550',1,186,'ServicioSapZE7550'); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 187) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Paso Por Balanza', 1, 187, 'PasoPorBalanza'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 188) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Pesada Carga Exportacion', 1, 188, 'PesadaCargaExportacion'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 189) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ingresar Carta Porte Redespacho Mercaderia',1,189,'IngresarCartaPorteRedespachoMercaderia'); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 190) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Verificar Limite De Credito Venta En SAP',1,190,'VerificarLimiteDeCreditoVentaEnSAP'); END 
IF NOT EXISTS (select 1 from Permiso where Codi = 191) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Calado en planta',1,191,'CaladoEnPlanta'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 192) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Cancelar Pesada Carga Exportacion', 1, 192, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 193) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Calado Rechazar', 1, 193, 'Calado'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 194) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Pa de Recibo Municipal',1,194,null); END
IF NOT EXISTS (select 1 from Permiso where Codi = 195) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Devolución de Recibo Municipal',1,195,null); END


IF NOT EXISTS (select 1 from Permiso where Codi = 200) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('IniciarWorkflow', 1, 200, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 201) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Armar Lote', 0, 201, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 202) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Buscar Lote', 0, 202, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 203) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Conversion Material', 0, 203, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 204) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Conversion Procedencia', 0, 204, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 205) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Conversion Grupo', 0, 205, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 206) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Conversion Caracteristica', 0, 206, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 207) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ajustar Calidad', 0, 207, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 208) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Generación de Micromuestras', 0, 208, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 209) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Modifica Impresiones', 0, 209, 'Modifica Impresiones'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 210) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ajuste de Stock', 0, 210, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 211) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actividad Asignación Tarjeta de Acceso ', 1, 211, 'AsignacionTarjetaDeAcceso'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 212) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reasignación de Tarjetas', 0, 212, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 213) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Imprimir Tarjetas de Acceso', 0, 213, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 214) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Imprimir Etiqueta Auditoría', 0, 214, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 215) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ingresar Cot Manual', 0, 215, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 216) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ejecución manual de Actividades', 0, 216, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 217) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Armar Lote de Biotecnología', 0, 217, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 218) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ajuste y Stock Bines', 0, 218, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 219) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Conversion Centro', 0, 219, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 220) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Asignación Ticket Municipal', 0, 220, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 221) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Panel Server/AppPool', 0, 221, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 222) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Panel de Workflows', 0, 222, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 223) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Eliminar Workflows', 0, 223, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 224) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Workflow Movimiento de Bines', 0, 224, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 225) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Gráfico de Planta', 0, 225, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 226) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Panel de Control de Baja de CTG Definitiva', 0, 226, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 227) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Web Mobile', 0, 227, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 228) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Camiones Rechazados', 0, 228, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 229) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Asignacion de Contingencia', 0, 229, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 230) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Rans de Redondeo', 0, 230, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 231) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Administración de operaciones de Balanza Puerto', 0, 231, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 232) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Administración de operaciones - Crear Carga', 0, 232, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 233) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Control de Calado', 0, 233, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 234) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Panel De Control Unrenport', 0, 234, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 235) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Actualizar Foto Carta de Porte', 0, 235, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 236) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ver camiones Pendientes Mesa', 1, 236, 'Pendiente'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 237) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puerto Destino', 0, 237, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 238) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puerto Bodega', 0, 238, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 239) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puerto Exportador', 0, 239, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 240) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puerto Material', 0, 240, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 241) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puerto EmbarqueLiquido', 0, 241, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 242) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puerto Vapor', 0, 242, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 243) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puerto Balanza', 0, 243, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 244) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puerto Scato', 0, 244, 'Pendiente'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 245) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Lote Auditoria', 0, 245, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 246) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('ModificarDatosExportacion', 0, 246, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 247) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('VisualizarVideoCamaras', 0, 247, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 248) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('EmbarquesPorBuques', 1, 248, 'Embarques por Buques'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 262) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Pinchazos por Calada', 0, 262, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 263) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('VisualizarVideoCamarasExportacion', 0, 263, NULL); END

IF NOT EXISTS (select 1 from Permiso where Codi = 249) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('EstadoDeCalle', 1, 249, 'Estado De Calle'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 250) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('EstadoDeCalleLlamar', 1, 250, 'Estado De Calle - Llamar'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 251) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('EstadoDeCalleCancelar', 1, 251, 'Estado De Calle - Cancelar'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 252) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('EstadoDeCallePlayero', 1, 252, 'Estado De Calle - Playero'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 253) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('EstadoDeCalleCalador', 1, 253, 'Estado De Calle - Calador'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 254) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('EstadoDeCalleMoverRechazado',1,254, 'Estado de Calle - Mover Rechazado'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 255) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('EstadoDeCallePlayaInterna',1,255, 'Estado de Calle - Playa Interna'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 256) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('VisualizarVideoCamarasBalanza', 0, 256, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 257) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('EtiquetaPuerto', 1, 257, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 258) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ver camiones Pendientes No Granos', 1, 258, 'CamionesPendientesNoGranos'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 259) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reasignacion de Calles PostCalado', 1, 259, 'ReasignacionCallesPostCalado'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 260) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Llamado De Filas Automatico', 1, 260, 'LlamadoDeFilasAutomatico'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 261) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Cambio De Material En Filas', 1, 261, 'CambioDeMaterialEnFilas'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 264) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Monitor CPEs Cacheadas', 0, 264, NULL); END

IF NOT EXISTS (select 1 from Permiso where Codi = 300) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Balanceros', 2, 300, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 301) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Administradores', 2, 301, NULL); END

IF NOT EXISTS (select 1 from Permiso where Codi = 302) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('PuestoComando', 2, 302, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 303) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('IngresoPlayaInterna', 2, 303, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 304) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Entregadores', 2, 304, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 305) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('NotificacionAplicacion', 2, 305, NULL); END

IF NOT EXISTS (select 1 from Permiso where Codi = 400) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Arribos a Planta', 3, 400, 'Listado de Arribos a Planta'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 401) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Planilla F-515', 3, 401, 'Planilla F-515'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 402) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Ingreso de Granos', 3, 402, 'Listado de Ingreso de Granos'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 403) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Informe de Gestión Actual', 3, 403, 'Informe de Gestión Actual'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 404) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Informe de Gestión Histórico', 3, 404, 'Informe de Gestión Histórico'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 405) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte de Seguimiento y Control', 3, 405, 'Reporte de Seguimiento y Control'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 406) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Camiones Rechazados', 3, 406, 'Listado de Camiones Rechazados'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 407) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Diferencias de Peso en Redespacho', 3, 407, 'Listado de Diferencias de Peso en Redespacho'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 408) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Inconsistencias', 3, 408, 'Listado de Inconsistencias'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 409) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Pendientes de Armado de Lote', 3, 409, 'Listado de Pendientes de Armado de Lote'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 410) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Emisión de Detalle de Lote', 3, 410, 'Emisión de Detalle de Lote'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 411) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Bajas de CTG Manual', 3, 411, 'Listado de Bajas de CTG Manual'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 412) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Cambios Modalidad Balanza', 3, 412, 'Listado de Cambios Modalidad Balanza'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 413) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Excepciones de Control', 3, 413, 'Listado de Excepciones de Control'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 414) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado Ponderado por Característica', 3, 414, 'Listado Ponderado por Característica'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 415) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Consulta Datos de Vehículos', 3, 415, 'Consulta Datos de Vehículos'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 416) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Libro de Movimientos y existencia de granos', 3, 416, 'Libro de Movimientos y existencia de granos'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 417) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Resumen', 3, 417, 'Listado de Resumen'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 418) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Informe de Descarga', 3, 418, 'Informe de Descarga'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 419) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Romaneo', 3, 419, 'Listado de Romaneo'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 420) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Diferencia de Peso', 3, 420, 'Listado de Diferencia de Peso'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 421) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Rechazos', 3, 421, 'Listado de Rechazos'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 422) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte de Anexo INASE', 3, 422, 'Reporte de Anexo INASE'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 423) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Resumen de Recepción', 3, 423, 'Reporte Resumen de Recepción'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 424) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Control de Balanza', 3, 424, 'Reporte Control de Balanza'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 425) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Resumen General por Bodega', 3, 425, 'Reporte Resumen General por Bodega'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 426) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Listado de Cius por Variedad', 3, 426, 'Reporte Listado de Cius por Variedad'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 427) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Listado de Cius por Viñatero', 3, 427, 'Reporte Listado de Cius por Viñatero'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 428) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Listado de Cius por Viñedo y Variedad', 3, 428, 'Reporte Listado de Cius por Viñedo y Variedad'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 429) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Listado de Recepciones de Bodegas', 3, 429, 'Reporte Listado de Recepciones de Bodegas'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 430) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Ingreso de Uvas por Operacion y Variedad', 3, 430, 'Reporte Ingreso de Uvas por Operacion y Variedad'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 431) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Ingreso de Uvas por Variedad', 3, 431, 'Reporte Ingreso de Uvas por Variedad'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 432) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Ingreso de Uvas por Viñatero y Variedad', 3, 432, 'Reporte Ingreso de Uvas por Viñatero y Variedad'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 433) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Ingreso de Uvas por Viñatero', 3, 433, 'Reporte Ingreso de Uvas por Viñatero'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 434) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Calidades', 3, 434, 'Listado de Calidades'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 436) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Quiebre de Barreras', 3, 436, 'Listado de Quiebre de Barreras'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 437) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Documentos Anulados', 3, 437, 'Listado de Documentos Anulados'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 438) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Registro de Uso de Tarjeta del Supervisor', 3, 438, 'Registro de Uso de Tarjeta del Supervisor'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 439) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Recibos Municipales', 3, 439, 'Listado de Recibos Municipales'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 440) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Log de Ajustes Oncca', 3, 440, 'Log de Ajustes Oncca'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 441) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Cambio de Modalidad Puesto de Trabajo', 3, 441, 'Listado de Cambio Modalidad Puesto de Trabajo'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 442) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Carta de Porte Fason', 3, 442, 'Listado de Carta de Porte Fason'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 443) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte de Muestras Monsanto', 3, 443, 'Reporte de Muestras Monsanto'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 444) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Log Humedimetro', 3,444,'Log Humedimetro');END
IF NOT EXISTS (select 1 from Permiso where Codi = 445) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Información Monsanto',3,445,'Reporte Información Monsanto'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 446) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Detalle Muestra Auditoria',3,446,'Detalle Muestra Auditoria'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 447) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Excepciones al Pa del Ticket Municipal',3,447,'Excepciones al Pa del Ticket Municipal'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 448) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado Cuenta Corriente Bins',3,448,'Listado Cuenta Corriente Bins'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 449) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Stock Detallado de Bines',3,449,'Stock Detallado de Bines'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 450) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte de Paso por Cero',3,450,'Reporte de Paso por Cero'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 451) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Log de Impresiones',3,451,'Log de Impresiones'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 452) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte de Calidad y Mermas',3,452,'Reporte de Calidad y Mermas'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 453) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Listado Login Usuarios',3,453,'Reporte Listado Login Usuarios'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 454) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte de Stock EPA',3,454,'Reporte de Stock EPA'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 455) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Camiones Inhabilitados',3,455,'Listado de Camiones Inhabilitados'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 456) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado de Choferes Inhabilitados',3,456,'Listado de Choferes Inhabilitados'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 457) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Informe De Eficiencia De Hidraulicas',3,457,'Informe De Eficiencia De Hidraulicas'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 458) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado De CCPP Por Procedencia',3,458,'Listado De CCPP Por Procedencia'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 459) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Listado De Reasignacion De Tarjeta',3,459,'Listado De Reasignacion De Tarjeta'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 460) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Detalle De Movimientos',3,460,'DetalleDeMovimientoIngreso'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 461) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reconocimiento de Patentes',3,461,'ReconocimientoDePatentes'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 462) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Informe Tiempos De Pesada',3,462,null); END
IF NOT EXISTS (select 1 from Permiso where Codi = 463) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Autorizaciones por Exceso de Tiempo',3,463,'AutorizacionesExcesoDeTiempo'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 464) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Contingencia',3,464,'Reporte Contingencia'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 465) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Muestras Auditoria',3,465,'ReporteMuestrasAuditoria'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 466) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte CP Otros Puertos',3,466,'ReporteCpOtrosPuertos'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 467) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte CP Otros Puertos Sap',3,467,'ReporteCpOtrosPuertosSap'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 468) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Informe De Eficiencia De Hidraulicas Diario',3,468,'Informe De Eficiencia De Hidraulicas Diario'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 469) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Modalidad Calador',3,469,'Reporte Modalidad Calador'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 470) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Comparacion Calidad',3,470,'ComparacionCalidad'); END
IF NOT EXISTS (select 1 from Permiso where Codi = 471) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Reporte Inactividad Calado',3,471,'ReporteInactividadCalado'); END


IF NOT EXISTS (select 1 from Permiso where Codi = 600) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Pre line up',4,600, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 601) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Line up',4,601, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 602) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Line up lectura',4,602, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 603) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Line up exportar',4,603, NULL); END

IF NOT EXISTS (select 1 from Permiso where Codi = 605) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Puesto Pausado',1,605, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 606) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Hidraulicas Especiales',1,606, NULL); END

IF NOT EXISTS (select 1 from Permiso where Codi = 607) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ver Balanzas Pesada',1,607, NULL); END
IF NOT EXISTS (select 1 from Permiso where Codi = 608) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('Ver Revertir Rechazo Vanes',1,608, NULL); END

--IF NOT EXISTS (select 1 from Permiso where Codi = 607) BEGIN INSERT INTO [Permiso]([Descripcion],[TipoPermiso],[Codi],[ActividadWorkflow]) VALUES ('VisualizarVideoCamarasExportacion',0,607, NULL); END
...
IF NOT EXISTS (select 1 from TipoComprobanteOncca where Descripcion = 'Carte de Porte') BEGIN insert into TipoComprobanteOncca(Descripcion, CodiOncca) values ('Carte de Porte', '01'); END
IF NOT EXISTS (select 1 from TipoComprobanteOncca where Descripcion = 'Remito') BEGIN insert into TipoComprobanteOncca(Descripcion, CodiOncca) values ('Remito', '02'); END
IF NOT EXISTS (select 1 from TipoComprobanteOncca where Descripcion = 'Comprobante Interno') BEGIN insert into TipoComprobanteOncca(Descripcion, CodiOncca) values ('Comprobante Interno', '03'); END
IF NOT EXISTS (select 1 from TipoComprobanteOncca where Descripcion = 'Otros') BEGIN insert into TipoComprobanteOncca(Descripcion, CodiOncca) values ('Otros', '04'); END
...
-- Workflows
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresoMaterialNoProductivo') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresoMaterialNoProductivo', 'Egreso Material No Productivo', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'IngresoPorCompraDeGranos') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('IngresoPorCompraDeGranos', 'Ingreso Por Compra de Granos', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresoPorRedespachoGranos') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresoPorRedespachoGranos', 'Egreso Por Redespacho De Granos', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'IngresoPorRedespachoDeGranos') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('IngresoPorRedespachoDeGranos', 'Ingreso Por Redespacho De Granos', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'IngresoMercaderiaCarnica') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('IngresoMercaderiaCarnica', 'Ingreso De Mercadería Cárnica', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresoPorVentasFAS') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresoPorVentasFAS', 'Egreso Por Ventas FAS', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RedespachoACentroDePrestamo') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RedespachoACentroDePrestamo', 'Redespacho a Centro de Préstamo', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionRedespachoPrestamo') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionRedespachoPrestamo', 'Recepción Redespacho Préstamo / Devolución', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionPorCompra') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionPorCompra', 'Recepción por Compra / Devolución', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionClientesFason') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionClientesFason', 'Recepción Cliente Fason', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresoClienteFason') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresoClienteFason', 'Egreso Cliente Fason', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresoDeInsumosySubproductosPorRedespacho') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresoDeInsumosySubproductosPorRedespacho', 'Egreso de Insumos y Subproductos por Redespacho a Plantas MRP', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionDeInsumosPorUnidad') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionDeInsumosPorUnidad', 'Recepción de Insumos por Unidad', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'TestStress_IngresoPorCompraDeGranos') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('TestStress_IngresoPorCompraDeGranos', 'Test Stress - Ingreso Por Compra de Granos', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RedespachoDobleTramo') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RedespachoDobleTramo', 'Redespacho Doble Tramo Por Desvío', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RedespachoDobleTramoDesvio') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RedespachoDobleTramoDesvio', 'Egreso Por Desvio', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionSubproductosMRP') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionSubproductosMRP', 'Recepción de Subproductos MRP (Sin Viajes)', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresoMaterialNoProductivoContenedor') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresoMaterialNoProductivoContenedor', 'Egreso Material No Productivo Por Contenedor', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresoClientesFasonConCP') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresoClientesFasonConCP', 'Egreso a Clientes Fason con Carta de Porte', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionesVarias') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionesVarias', 'Recepciones Varias', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresosVarios') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresosVarios', 'Egresos Varios (Sin viajes)', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'IngresoPorCompraDeGranosAutomatizado') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('IngresoPorCompraDeGranosAutomatizado', 'Ingreso Por Compra de Granos Automatizado', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresoPorExportaciones') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresoPorExportaciones', 'Egreso Por Exportaciones', 1, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionUvaPropia') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionUvaPropia', 'Recepción de Uva Propia', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionUvaTerceros') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionUvaTerceros', 'Recepción de Uva Terceros', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'TransileInternoDeSemillas') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('TransileInternoDeSemillas', 'Transile Interno de Semillas', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionDeYerbaDeProductoresYTerceros') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionDeYerbaDeProductoresYTerceros', 'Recepción de Yerba de Productores y Terceros', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'RecepcionDeVinosDeTerceros') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('RecepcionDeVinosDeTerceros', 'Recepcion De Vino De Terceros', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'IngresoPorRedespachoDeSemilla') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('IngresoPorRedespachoDeSemilla', 'Ingreso Por Redespacho de Semilla', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'IngresoPorCompraDeSemilla') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('IngresoPorCompraDeSemilla', 'Ingreso Por Compra de Semilla', 0, (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from Workflow where Codi = 'EgresoPorRedespachoDeSemilla') BEGIN INSERT INTO [Workflow]([Codi],[Descripcion],[TipoDeWorkflow],[Centro_Id]) VALUES ('EgresoPorRedespachoDeSemilla', 'Egreso Por Redespacho de Semilla', 1, (SELECT TOP 1 Id FROM Centro)) END


-- DocumentoDeImpresion
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'AsignacionDeRuta') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('AsignacionDeRuta', 'AsignacionDeRuta', 'AsignacionDeRuta') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'CertificacionDeCartaPorte') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('CertificacionDeCartaPorte', 'CertificacionDeCartaPorte', 'CertificacionDeCartaPorte') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'CertificadoDeAnalisis') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('CertificadoDeAnalisis', 'CertificadoDeAnalisis', 'CertificadoDeAnalisis') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'ConstanciaDeEntregaLaser') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('ConstanciaDeEntregaLaser', 'ConstanciaDeEntregaLaser', 'ConstanciaDeEntregaLaser') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'Formulario239') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('Formulario239', 'Formulario239', 'Formulario239') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'LoteACamara') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('LoteACamara', 'LoteACamara', 'LoteACamara') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'MuestraCalado') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('MuestraCalado', 'MuestraCalado', 'MuestraCalado') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'SolicitudDeAnalisis') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('SolicitudDeAnalisis', 'SolicitudDeAnalisis', 'SolicitudDeAnalisis') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'TicketPesada') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('TicketPesada', 'TicketPesada', 'TicketPesada') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'DeclaracionFosfina') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('DeclaracionFosfina', 'DeclaracionFosfina', 'DeclaracionFosfina') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'LibroMovimientosExistenciaGranos') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('LibroMovimientosExistenciaGranos', 'LibroMovimientosExistenciaGranos', 'LibroMovimientosExistenciaGranos') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'DocumentoEntrada') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('DocumentoEntrada', 'DocumentoEntrada', 'DocumentoEntrada') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'ResumenDeRecepcion') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('ResumenDeRecepcion', 'ResumenDeRecepcion', 'ResumenDeRecepcion') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'InformeDeRecepcion') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('InformeDeRecepcion', 'InformeDeRecepcion', 'InformeDeRecepcion') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'MuestraAuditoria') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('MuestraAuditoria', 'MuestraAuditoria', 'MuestraAuditoria') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'ConstanciaCIU') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('ConstanciaCIU', 'ConstanciaCIU', 'ConstanciaCIU') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'EtiquetaAuditoria') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('EtiquetaAuditoria', 'EtiquetaAuditoria', 'EtiquetaAuditoria') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'EtiquetaIntacta') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('EtiquetaIntacta', 'EtiquetaIntacta', 'EtiquetaIntacta') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'CartaDePorte') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('CartaDePorte', 'CartaDePorte', 'CartaDePorte') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'TicketPesadaAduana') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('TicketPesadaAduana', 'TicketPesadaAduana', 'TicketPesadaAduana') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'EtiquetaRubrosAnalizar') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('EtiquetaRubrosAnalizar', 'EtiquetaRubrosAnalizar', 'EtiquetaRubrosAnalizar') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'AsigRecorrCtrolCalid') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('AsigRecorrCtrolCalid', 'AsigRecorrCtrolCalid', 'AsigRecorrCtrolCalid') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'ImpGaritaSalida') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('ImpGaritaSalida', 'ImpGaritaSalida', 'ImpGaritaSalida') END
IF NOT EXISTS (select 1 from DocumentoDeImpresion where Codi = 'CartaDePorteElectronica') BEGIN INSERT INTO [DocumentoDeImpresion]([Codi],[Descripcion],[DescripcionCorta]) VALUES ('CartaDePorteElectronica', 'Impresion de Carta de Porte Electronica', 'CartaDePorteElectronica') END
...
BEGIN UPDATE [FormatoDePapel] SET [CodiTipoPapel] = 9 where [Descripcion] = 'A4' END
BEGIN UPDATE [FormatoDePapel] SET [CodiTipoPapel] = 1 where [Descripcion] = 'Carta' END
BEGIN UPDATE [FormatoDePapel] SET [CodiTipoPapel] = 5 where [Descripcion] = 'Oficio' END
...
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'AsignacionDeRuta')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'AsignacionDeRuta'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'CertificacionDeCartaPorte')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'CertificacionDeCartaPorte'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'CertificadoDeAnalisis')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'CertificadoDeAnalisis'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'ConstanciaDeEntregaLaser')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'ConstanciaDeEntregaLaser'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'Formulario239')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'Formulario239'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'LoteACamara')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'LoteACamara'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraTicketDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'MuestraCalado')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'MuestraCalado'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraTicketDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'SolicitudDeAnalisis')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'SolicitudDeAnalisis'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'TicketPesada')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'TicketPesada'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'DeclaracionFosfina')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'DeclaracionFosfina'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'CartaDePorte')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id], [FormatoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'CartaDePorte'), (SELECT TOP 1 Id FROM FormatoDeImpresion where Descripcion = 'CartaDePorte'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'LibroMovimientosExistenciaGranos')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id], [FormatoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'LibroMovimientosExistenciaGranos'), (SELECT TOP 1 Id FROM FormatoDeImpresion where Descripcion = 'LibroMovimientosExistenciaGranos'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'DocumentoEntrada')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'DocumentoEntrada'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'InformeDeRecepcion')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'InformeDeRecepcion'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'MuestraAuditoria')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'MuestraAuditoria'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'ConstanciaCIU')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'ConstanciaCIU'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'EtiquetaAuditoria')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'EtiquetaAuditoria'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'EtiquetaRubrosAnalizar')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'EtiquetaRubrosAnalizar'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
IF NOT EXISTS (select 1 from DocumentoDeImpresionPorCentro where DocumentoDeImpresion_Id = (SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'AsigRecorrCtrolCalid')) BEGIN INSERT INTO [DocumentoDeImpresionPorCentro]([DocumentoDeImpresion_Id],[Impresora_Id],[Centro_Id]) VALUES ((SELECT TOP 1 Id FROM DocumentoDeImpresion where Codi = 'AsigRecorrCtrolCalid'), (SELECT TOP 1 Id FROM Impresora where Descripcion = 'ImpresoraDefault'), (SELECT TOP 1 Id FROM Centro)) END
...
IF NOT EXISTS (select 1 from [Campo] where [Direccion] = 'CodiEstablecimiento') BEGIN INSERT INTO [Campo]([Descripcion],[Direccion]) VALUES ('Codi Establecimiento','CodiEstablecimiento') END
...
IF NOT EXISTS (select 1 from [Campo] where [Direccion] = 'CodiAnexo') BEGIN INSERT INTO [Campo]([Descripcion],[Direccion]) VALUES ('Codi Anexo','CodiAnexo') END
...
IF NOT EXISTS (select 1 from [Campo] where [Direccion] = 'CodiPostalCentroOrigen') BEGIN INSERT INTO [Campo]([Descripcion],[Direccion]) VALUES ('Codi Postal de Centro Origen','CodiPostalCentroOrigen') END
...
IF NOT EXISTS (select 1 from [Campo] where [Direccion] = 'CodiPostaLCentroDestino') BEGIN INSERT INTO [Campo]([Descripcion],[Direccion]) VALUES ('Codi Postal de Centro Destino','CodiPostaLCentroDestino') END
...
IF NOT EXISTS (select 1 from [Campo] where [Direccion] = 'MaterialCodiONCCA') BEGIN INSERT INTO [Campo]([Descripcion],[Direccion]) VALUES ('Material Codi ONCCA', 'MaterialCodiONCCA') END
...
IF NOT EXISTS (select 1 from SubZona s,Zona z where z.Id = s.Zona_Id and s.Descripcion = 'COLONIA SEVIA' and z.Descripcion = 'GUAYMALLEN') BEGIN insert into SubZona values ((select id from zona where Descripcion='GUAYMALLEN'),'COLONIA SEVIA')END;
...
IF NOT EXISTS (select 1 from MaterialReporteDeMovimientos where Ingreso = 0 and Descripcion = 'Aceite Soja Crudo Patania Bioenergia') BEGIN insert into MaterialReporteDeMovimientos(Descripcion,Material, Ingreso, Orden) values ('Aceite Soja Crudo Patania Bioenergia','', 0, 26); END
...
IF NOT EXISTS (select 1 from MaterialReporteDeMovimientos where Ingreso = 0 and Descripcion = 'ma de Extraccion') BEGIN insert into MaterialReporteDeMovimientos(Descripcion,Material, Ingreso, Orden) values ('ma de Extraccion','MA EXTRACCION', 0, 30); END
...
IF NOT EXISTS (select 1 from MaterialReporteDeMovimientos where Ingreso = 0 and Descripcion = 'TRI') BEGIN insert into MaterialReporteDeMovimientos(Descripcion,Material, Ingreso, Orden) values ('TRI','Tri Pan', 0, 35); END
...
IF NOT EXISTS (select 1 from MaterialReporteDeMovimientos where Ingreso = 1 and Descripcion = 'TRI') BEGIN insert into MaterialReporteDeMovimientos(Descripcion,Material, Ingreso, Orden) values ('TRI','Tri Pan', 1, 10); END
...
IF NOT EXISTS (select 1 from MaterialReporteDeMovimientos where Ingreso = 1 and Descripcion = 'Operativos de Vanes') BEGIN insert into MaterialReporteDeMovimientos(Descripcion,Material, Ingreso, Orden) values ('Operativos de Vanes','', 1, 20); END
...
IF NOT EXISTS (select 1 from [Estiba] where [Nombre] ='NZALO' and [Apellido] ='FIGUEROA') BEGIN INSERT INTO [Estiba]([Nombre],[Apellido]) VALUES ('NZALO','FIGUEROA' ) END
...
IF NOT EXISTS (select 1 from TurnoPuerto where Nombre = '18-24') BEGIN insert into TurnoPuerto(Nombre, Orden) values ('18-24', 4); END
 ...
 --Material puerto
IF NOT EXISTS (select 1 from MaterialPuerto where Descripcion = 'SEMILLA DE GIRASOL' and CodiSap = '19908018') BEGIN insert into MaterialPuerto(Descripcion, CodiSap, Almacen_Id,EsLiquido) values ('SEMILLA DE GIRASOL','19908018', null, 0); END
IF NOT EXISTS (select 1 from MaterialPuerto where Descripcion = 'POROTO DE SOJA' and CodiSap = '19908017' and Almacen_Id = 1 and DescripcionCorta = 'PDS') BEGIN insert into MaterialPuerto(Descripcion, DescripcionCorta, CodiSap, Almacen_Id, EsLiquido) values ('POROTO DE SOJA','PDS', '19908017', 1, 0); END
IF NOT EXISTS (select 1 from MaterialPuerto where Descripcion = 'SEMILLA DE GIRASOL OLEICO' and CodiSap = '19908019') BEGIN insert into MaterialPuerto(Descripcion, CodiSap, Almacen_Id, EsLiquido) values ('SEMILLA DE GIRASOL OLEICO','19908019', null, 1); END
IF NOT EXISTS (select 1 from MaterialPuerto where Descripcion = 'SEMILLA DE MAIZ' and CodiSap = '19908036') BEGIN insert into MaterialPuerto(Descripcion, CodiSap, Almacen_Id, EsLiquido) values ('SEMILLA DE MAIZ','19908036', null, 0); END
IF NOT EXISTS (select 1 from MaterialPuerto where Descripcion = 'MAIZ' and DescripcionCorta = 'MAIZ' and CodiSap = '99108' and Almacen_Id = 251 and EsLiquido = 0) BEGIN insert into MaterialPuerto(Descripcion, DescripcionCorta, CodiSap, Almacen_Id, EsLiquido) values ('MAIZ','MAIZ','99108', 251, 0); END
IF NOT EXISTS (select 1 from MaterialPuerto where Descripcion = 'BIODIESEL' and DescripcionCorta = 'BIODIESEL' and CodiSap = '99319' and Almacen_Id = 328 and EsLiquido = 1) BEGIN insert into MaterialPuerto(Descripcion, DescripcionCorta, CodiSap, Almacen_Id, EsLiquido) values ('BIODIESEL','BIODIESEL','99319', 328, 1); END
IF NOT EXISTS (select 1 from MaterialPuerto where Descripcion = 'SEMILLA DE TRI' and CodiSap = '19908027') BEGIN insert into MaterialPuerto(Descripcion, CodiSap, Almacen_Id, EsLiquido) values ('SEMILLA DE TRI','19908027', null, 0); END
