CREATE TABLE [dbo].[HistoricoInhabilitacionCamion] (
    ...
    CONSTRAINT [PK_dbo.HistoricoInhabilitacionCamion] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_InhabilitacionCamion_Id]
    ON [dbo].[HistoricoInhabilitacionCamion]([InhabilitacionCamion_Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
