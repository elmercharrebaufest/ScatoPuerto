CREATE TABLE [dbo].[OrdenCargaInternaFason] (
    ...
    CONSTRAINT [PK_dbo.OrdenCargaInternaFason] PRIMARY KEY CLUSTERED ([Id] ASC),
...
CREATE NONCLUSTERED INDEX [IX_Transportista_Id]
    ON [dbo].[OrdenCargaInternaFason]([Transportista_Id] ASC);

GO
CREATE NONCLUSTERED INDEX [IX_TipoComercial_Id]
    ON [dbo].[OrdenCargaInternaFason]([TipoComercial_Id] ASC);

GO
CREATE NONCLUSTERED INDEX [IX_Material_Id]
    ON [dbo].[OrdenCargaInternaFason]([Material_Id] ASC);

GO
CREATE NONCLUSTERED INDEX [IX_Chofer_Id]
    ON [dbo].[OrdenCargaInternaFason]([Chofer_Id] ASC);

GO
CREATE NONCLUSTERED INDEX [IX_Recorrido_Id]
    ON [dbo].[OrdenCargaInternaFason]([Recorrido_Id] ASC);
