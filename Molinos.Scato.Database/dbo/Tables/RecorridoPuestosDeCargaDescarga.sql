CREATE TABLE [dbo].[RecorridoPuestosDeCargaDescarga] (
    ...
    CONSTRAINT [PK_dbo.RecorridoPuestosDeCargaDescarga] PRIMARY KEY CLUSTERED ([Recorrido_Id] ASC, [PuestosDeCargaDescarga_Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_Recorrido_Id]
    ON [dbo].[RecorridoPuestosDeCargaDescarga]([Recorrido_Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_PuestosDeCargaDescarga_Id]
    ON [dbo].[RecorridoPuestosDeCargaDescarga]([PuestosDeCargaDescarga_Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON);
