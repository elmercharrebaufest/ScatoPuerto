CREATE TABLE [dbo].[CartaPorteVagonFerroviarioRegistroTransmisionAMonsanto] (
    [Id]               INT NOT NULL,
	...
	CantidadVagones int NULL,
	NumeroCartaPorte BIGINT NULL,

	CONSTRAINT [PK_dbo.CartaPorteVagonFerroviarioRegistroTransmisionAMonsanto] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_dbo.CartaPorteVagonFerroviarioRegistroTransmisionAMonsanto_dbo.TransmisionASapId] FOREIGN KEY ([Id]) REFERENCES [dbo].[TransmisionASap] ([Id]) ON DELETE CASCADE
);
GO
