...
CONSTRAINT [FK_dbo.NominacionDetalleIntervencion_dbo.NominacionDetalleIntervencion_Nominacion_Id] FOREIGN KEY ([Nominacion_Id]) REFERENCES [dbo].[Nominacion] ([Id]),
