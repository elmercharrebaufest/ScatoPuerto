CREATE TABLE [dbo].[Calado] (
    ...
    CONSTRAINT [PK_dbo.Calado] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_Calado_WorkflowInstanceId]
    ON [dbo].[Calado]([WorkflowInstanceId] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
