CREATE TABLE [dbo].[UsuarioCentro] (
    ...
    CONSTRAINT [PK_dbo.UsuarioCentro] PRIMARY KEY CLUSTERED ([Usuario_Id] ASC, [Centro_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_Usuario_Id]
    ON [dbo].[UsuarioCentro]([Usuario_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_Centro_Id]
    ON [dbo].[UsuarioCentro]([Centro_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
