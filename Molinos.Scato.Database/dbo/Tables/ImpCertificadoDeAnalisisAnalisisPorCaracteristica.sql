CREATE TABLE [dbo].[ImpCertificadoDeAnalisisAnalisisPorCaracteristica] (
    ...
    CONSTRAINT [PK_dbo.ImpCertificadoDeAnalisisAnalisisPorCaracteristica] PRIMARY KEY CLUSTERED ([ImpCertificadoDeAnalisis_Id] ASC, [AnalisisPorCaracteristica_Id] ASC),
...
CREATE NONCLUSTERED INDEX [IX_ImpCertificadoDeAnalisis_Id]
    ON [dbo].[ImpCertificadoDeAnalisisAnalisisPorCaracteristica]([ImpCertificadoDeAnalisis_Id] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_AnalisisPorCaracteristica_Id]
    ON [dbo].[ImpCertificadoDeAnalisisAnalisisPorCaracteristica]([AnalisisPorCaracteristica_Id] ASC);
