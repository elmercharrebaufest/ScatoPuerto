CREATE TABLE [dbo].[UsuarioRol] (
    ...
    [Rol_Id]     INT NOT NULL,
    CONSTRAINT [PK_dbo.UsuarioRol] PRIMARY KEY CLUSTERED ([Usuario_Id] ASC, [Rol_Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_Usuario_Id]
    ON [dbo].[UsuarioRol]([Usuario_Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_Rol_Id]
    ON [dbo].[UsuarioRol]([Rol_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
