CREATE TABLE [dbo].[TarjetaBloqueada] (
    ...
    [Centro_Id] INT           NULL,
    CONSTRAINT [PK_dbo.TarjetaBloqueada] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_Centro_Id]
    ON [dbo].[TarjetaBloqueada]([Centro_Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
