CREATE TABLE [dbo].[ImpCertificadoDeAnalisisCaladoPorCaracteristica] (
    ...
    CONSTRAINT [PK_dbo.ImpCertificadoDeAnalisisCaladoPorCaracteristica] PRIMARY KEY CLUSTERED ([ImpCertificadoDeAnalisis_Id] ASC, [CaladoPorCaracteristica_Id] ASC),
...
CREATE NONCLUSTERED INDEX [IX_ImpCertificadoDeAnalisis_Id]
    ON [dbo].[ImpCertificadoDeAnalisisCaladoPorCaracteristica]([ImpCertificadoDeAnalisis_Id] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_CaladoPorCaracteristica_Id]
    ON [dbo].[ImpCertificadoDeAnalisisCaladoPorCaracteristica]([CaladoPorCaracteristica_Id] ASC);
