CREATE TABLE [dbo].[ActividadPorDispositivo] (
    ...
    CONSTRAINT [PK_dbo.ActividadPorDispositivo] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_PuestoDeTrabajo_Id]
    ON [dbo].[ActividadPorDispositivo]([PuestoDeTrabajo_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);



GO
CREATE NONCLUSTERED INDEX [IX_Workflow_Id]
    ON [dbo].[ActividadPorDispositivo]([Workflow_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
