CREATE TABLE [dbo].[PuestoDeTrabajoTarjetaSupervisor] (
    ...
    CONSTRAINT [PK_dbo.PuestoDeTrabajoTarjetaSupervisor] PRIMARY KEY CLUSTERED ([TarjetaSupervisor_Id] ASC, [PuestoDeTrabajo_Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_TarjetaSupervisor_Id]
    ON [dbo].[PuestoDeTrabajoTarjetaSupervisor]([TarjetaSupervisor_Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_PuestoDeTrabajo_Id]
    ON [dbo].[PuestoDeTrabajoTarjetaSupervisor]([PuestoDeTrabajo_Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
