CREATE TABLE [dbo].[ImpAsigRecorrCtrolCalidCaladoPorCaracteristica] (
    ...
    CONSTRAINT [PK_dbo.ImpAsigRecorrCtrolCalidCaladoPorCaracteristica] PRIMARY KEY CLUSTERED ([ImpAsigRecorrCtrolCalid_Id] ASC, [CaladoPorCaracteristica_Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON),
...
CREATE NONCLUSTERED INDEX [IX_ImpAsigRecorrCtrolCalid_Id]
    ON [dbo].[ImpAsigRecorrCtrolCalidCaladoPorCaracteristica]([ImpAsigRecorrCtrolCalid_Id] ASC) WITH (STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_CaladoPorCaracteristica_Id]
    ON [dbo].[ImpAsigRecorrCtrolCalidCaladoPorCaracteristica]([CaladoPorCaracteristica_Id] ASC) WITH (FILLFACTOR = 90, STATISTICS_NORECOMPUTE = ON);
