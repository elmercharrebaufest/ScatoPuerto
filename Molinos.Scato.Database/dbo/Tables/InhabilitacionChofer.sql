...
CREATE NONCLUSTERED INDEX [IX_Chofer_Id]
    ON [dbo].[InhabilitacionChofer]([Chofer_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
...
CREATE NONCLUSTERED INDEX [IX_Centro_Id]
    ON [dbo].[InhabilitacionChofer]([Centro_Id] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON, STATISTICS_NORECOMPUTE = ON);
