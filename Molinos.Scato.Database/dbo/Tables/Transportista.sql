CREATE TABLE [dbo].[Transportista] (
    ...
    [Domicilio]    NVARCHAR (35) NULL DEFAULT 'Sin Direccion',
    [Localidad_Id] INT            NULL,
    [Provincia_Id] INT            NULL,
    [MedioDePago] INT NOT NULL DEFAULT 0, 
    CONSTRAINT [PK_dbo.Transportista] PRIMARY KEY CLUSTERED ([Id] ASC),
...
CREATE NONCLUSTERED INDEX [IX_Localidad_Id]
    ON [dbo].[Transportista]([Localidad_Id] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_Provincia_Id]
    ON [dbo].[Transportista]([Provincia_Id] ASC);
