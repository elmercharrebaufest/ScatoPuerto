...
{
    public class ModuloDeCargaManosDeEmbarqueDetalleHistorico : IIdentificable
    {
        [Key]
        public virtual int Id { get; set; }
        public virtual ModuloDeCargaManosDeEmbarqueHistorico ModuloDeCargaManosDeEmbarqueHistorico { get; set; }
