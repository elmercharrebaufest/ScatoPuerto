...
{
    public sealed class MovimientoDeBinesDto : IValidatableObject
    {
        ...
        public int CentroOrigenId { get; set; }
        public string CentroOrigenDescripcion { get; set; }
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult(String.Format(Textos.Error_NumericoYRango,"Cantidad"), new[] { "Cantidad" });
            }
