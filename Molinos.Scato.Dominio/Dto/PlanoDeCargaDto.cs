...
{
    public class PlanoDeCargaDto : ICloneable
    {
        ...
        public IList<CargaComercialDto> CargasComerciales { get; set; }
        public IList<PlanoDeCargaBodegaDto> PlanoDeCargaBodegas { get; set; }
