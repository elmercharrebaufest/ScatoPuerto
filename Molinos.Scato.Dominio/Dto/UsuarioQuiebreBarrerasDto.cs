...
namespace Molinos.Scato.Dominio.Dto
{
    public sealed class UsuarioQuiebreBarrerasDto
    {
        ...
        [Display(ResourceType = typeof(Textos), Name = "AvisoPlanoDeCarga")]
        public bool AvisoPlanoDeCarga { get; set; }
        [Display(ResourceType = typeof(Textos), Name = "AvisoModuloDeCarga")]
        public bool AvisoModuloDeCarga { get; set; }
    }
}
