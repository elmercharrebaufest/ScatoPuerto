...
namespace Molinos.Scato.Actividades.Internas
{
    ...
    public class EnviarMailAsync : CodeActivity
    {
        [RequiredArgument]
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            Task.Run(() => EnviarMail(context, message, servComando, instanceId));
        }

        private void EnviarMail(CodeActivityContext context, MailMessage message, IServicioComandos servComando, Guid instanceId)
        {
            try
            {
