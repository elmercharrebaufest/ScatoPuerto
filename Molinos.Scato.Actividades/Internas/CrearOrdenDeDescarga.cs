...
{
    public class CrearOrdenDeDescarga : CodeActivity<Resultado>
    {
        [RequiredArgument]
        public InArgument<OrdenDeDescargaDto> Orden { get; set; }
        ...
        {
            var orden = Orden.Get<OrdenDeDescargaDto>(context);
            ...
            try
            {
                ...
                var resultadoCrear = servicioComandos.Ejecutar(new Dominio.Comandos.CrearOrdenDeDescarga
                {
                    Orden = orden,
                ...
                var ordenDto = srvRepositorio.ObtenerOrdenDeDescarga(resultado.Id);
                if (ordenDto != null)
                {
                    ...
                    TipoDocumentoIngreso.Set(context, Dominio.Enums.TipoDocumentoIngreso.OrdenDeDescarga);
                }
