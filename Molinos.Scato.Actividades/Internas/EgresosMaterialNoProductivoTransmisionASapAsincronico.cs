...
{
    public class EgresosMaterialNoProductivoTransmisionASapAsincronico : CodeActivity<Resultado>
    {
        [RequiredArgument]
        ...
        protected override Resultado Execute(CodeActivityContext context)
        {
            ...
            try
            {
                servicioSap.EgresosMaterialNoProductivo(instanceId, request.EgresosNoProductivos);
