...
{
    public class RegistrarCartadePorteTransmisionAMonsanto : CodeActivity<Resultado>
    {
        ...
        protected override Resultado Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                var respuesta = servicio.registrarCartaDePorte(new registrarCartaDePorte(request));
