...
{
    public class EgresoSinFleteFasonesTransmisionASapAsincronico : CodeActivity<Resultado>
    {
        [RequiredArgument]
        ...
        protected override Resultado Execute(CodeActivityContext context)
        {
            ...
            try
            {
                servicioSap.EgresoSinFleteFazones(instanceId, request.EgresoSinFleteFazones);
