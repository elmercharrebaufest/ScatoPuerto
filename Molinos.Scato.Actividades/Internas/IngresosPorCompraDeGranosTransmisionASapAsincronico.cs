...
{
    public class IngresosPorCompraDeGranosTransmisionASapAsincronico : CodeActivity<Resultado>
    {
        [RequiredArgument]
        ...
        protected override Resultado Execute(CodeActivityContext context)
        {
            ...
            try
            {
                servicioSap.IngresoPorCompraDeGranos(instanceId, request.Fill_Z1000);
