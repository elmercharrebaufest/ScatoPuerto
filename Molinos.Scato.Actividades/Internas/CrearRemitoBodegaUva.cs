...
{
    public class CrearRemitoBodegaUva : CodeActivity<Resultado>
    {
        [RequiredArgument]
        public InArgument<RemitoBodegaUvaDto> Orden { get; set; }
        ...
        [RequiredArgument]
        public InArgument<bool> EsPropia { get; set; }

        public OutArgument<RemitoBodegaUvaDto> RemitoBodegaUva { get; set; }
        ...
        protected override Resultado Execute(CodeActivityContext context)
        {
            ...
            try
            {
                ...
                var resultadoCrear = servicioComandos.Ejecutar(new Dominio.Comandos.CrearRemitoBodegaUva
                {
                    Orden = orden,
                ...
                var ordenDto = srvRepositorio.ObtenerRemitoBodegaUva(resultado.Id);
                if (ordenDto != null)
                {
                    RemitoBodegaUva.Set(context, ordenDto);
                    FechaInicio.Set(context, DateTime.Now);
                    TipoDocumentoIngreso.Set(context, esPropia ? Dominio.Enums.TipoDocumentoIngreso.RemitoBodegaUvaPropia : Dominio.Enums.TipoDocumentoIngreso.RemitoBodegaUvaTerceros);
