...
{
    public class CrearHojaDeRutaYerbatera : CodeActivity<Resultado>
    {
        [RequiredArgument]
        public InArgument<HojaDeRutaYerbateraDto> Orden { get; set; }
        ...
        public OutArgument<HojaDeRutaYerbateraDto> HojaDeRutaYerbatera { get; set; }

        public OutArgument<string> NumeroHojaDeRutaYerbatera { get; set; }
        ...
        {
            var orden = Orden.Get<HojaDeRutaYerbateraDto>(context);
            ...
            try
            {
                ...
                var resultadoHojaDeRutaYerbatera = servicioComandos.Ejecutar(new Dominio.Comandos.CrearHojaDeRutaYerbatera
                {
                    Orden = orden,
                ...
                resultado.Id = resultadoHojaDeRutaYerbatera.Id;

                var ordenDto = srvRepositorio.ObtenerHojaDeRutaYerbatera(resultado.Id);
                if (ordenDto != null)
                {
                    HojaDeRutaYerbatera.Set(context, ordenDto);
                    FechaInicio.Set(context, DateTime.Now);
                    NumeroHojaDeRutaYerbatera.Set(context, ordenDto.NroHojaDeRutaYerbatera);
                    TipoDocumentoIngreso.Set(context, Dominio.Enums.TipoDocumentoIngreso.HojaDeRutaYerbatera);
                }
                if (resultadoHojaDeRutaYerbatera.HayErrores)
                {
