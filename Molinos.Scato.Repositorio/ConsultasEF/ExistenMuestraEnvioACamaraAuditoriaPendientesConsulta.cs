...
{
    public class ExistenMuestraEnvioACamaraAuditoriaPendientesConsulta : IConsultaEscalar<bool>
    {
        private readonly int materialId;
        private readonly int centroId;

        public ExistenMuestraEnvioACamaraAuditoriaPendientesConsulta(int materialId, int centroId)
        {
        ...
        public bool Ejecutar(DbContext contexto)
        {
            ...
            return contexto.Database.SqlQuery<int>(
                @"(SELECT COUNT(*)
                    ...
                    R.Terminado = 1 AND (R.TipoDocumentoIngreso = 1 or R.TipoDocumentoIngreso = 7) AND R.EnvioMuestraAuditoriaCamara = 1 AND
