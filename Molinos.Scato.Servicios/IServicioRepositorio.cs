...
namespace Molinos.Scato.Servicios
{
    ...
    public interface IServicioRepositorio
    {
        ...
        [OperationContract]
        IList<MaterialPorCentroDto> BuscarMaterialesPorCentro(int centroId, string filtro);
        ...
        [OperationContract]
        CartaPorteResponseDto ObtenerCartaPorteRedespachoPorNumero(string numero, int centroId, string workflowCodigo);
        ...
        [OperationContract]
        CartaPorteValidaResponseDto NumeroCartaPorteValido(string numero, int centroId, string workflowCodigo);
        ...
        [OperationContract]
        GraficoEficienciaHidraulicasDto ObtenerGraficoDeEficienciaHidraulicas(GraficoEficienciaHidraulicasDto model, int centroId);
