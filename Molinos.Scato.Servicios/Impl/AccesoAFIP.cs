...
{
    public abstract class AccesoAFIP : IAccesoAFIP
    {
        ...
        public abstract string PathCertificado { get; }

        public AccesoAFIP(IServicioComandos servicioComandos, IRepositorio repositorio, LoginCMS serviceAfip, IServicioRepositorio servicio, ILogger log)
        {
        ...
        public TicketAccesoAfip Obtener(string cuitRepresentado, Resultado resultado, string servicio)
        {
        ...
        private string EncriptarXmlLoginTicketRequest(XmlDocument xmlLoginTicketRequest, string pathCertificado)
        {
            ...
            {
                Log.Error(e, "Hubo un error al encriptar el ticket request de AFIP ");
                throw e;
            }
