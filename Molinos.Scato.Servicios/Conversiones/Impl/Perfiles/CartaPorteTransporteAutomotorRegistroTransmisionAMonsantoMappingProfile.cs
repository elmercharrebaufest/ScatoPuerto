...
{
    public class CartaPorteTransporteAutomotorRegistroTransmisionAMonsantoMappingProfile : Profile
    {
        public override string ProfileName
        {
            get { return "CartaPorteTransporteAutomotorRegistroTransmisionAMonsantoMappingProfile"; }
        }
        protected override void Configure()
        {
            Mapper.CreateMap<CartaPorteTransporteAutomotorRegistroTransmisionAMonsanto, CartaPorteTransporteAutomotorRegistro>()
                .ForMember(x => x.ctg, mat => mat.MapFrom(m => m.Ctg))
            ...
            Mapper.CreateMap<CartaPorteTransporteAutomotorRegistro, CartaPorteTransporteAutomotorRegistroTransmisionAMonsanto>()
                .ForMember(x => x.Ctg, mat => mat.MapFrom(m => m.ctg))
