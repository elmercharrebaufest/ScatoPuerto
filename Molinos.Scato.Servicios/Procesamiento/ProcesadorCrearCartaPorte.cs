            ...
            try
            {
                ...
                if (workflow != null)
                {
                        ...
                        cartaPorte = new CartaPorte
                            {
                                ...
                                NroCartaPorte = comando.Orden.NroCartaPorte,
                                CTG = comando.Orden.CTG,
                        ...
                        recorrido = new Recorrido
                            {
                                ...
                                NumeroDocumentoIngreso = comando.Orden.NroCartaPorte.ToString(CultureInfo.InvariantCulture),
                    ...
                    else
                    {
                        ...
                        recorrido.NumeroDocumentoIngreso = comando.Orden.NroCartaPorte.ToString(CultureInfo.InvariantCulture);
