...
{
    public class ProcesadorModificarExcepcionEnvioCamara : ProcesadorCrear<ModificarExcepcionEnvioCamara, ExcepcionEnvioCamara>
    {
        public ProcesadorModificarExcepcionEnvioCamara(IRepositorio repositorio, IConversor conversor, ILogger log)
            : base(repositorio, conversor, log)
        {
        }

        protected override ExcepcionEnvioCamara CrearEntidad(ModificarExcepcionEnvioCamara comando)
        {
        ...
        protected override void Validar(ModificarExcepcionEnvioCamara comando, Resultado resultado)
        {
