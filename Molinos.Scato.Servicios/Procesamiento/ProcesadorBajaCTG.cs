    ...
    public class ProcesadorBajaCTG : ProcesadorComando<DarDeBajaCTG>
    {
        ...
        public override Resultado Ejecutar(DarDeBajaCTG comando)
        {
            ...
            try
            {
                ...
                if (response.response != null && response.response.arrayErrores.Any())
                {
                        ...
                        new BajaCTG
                            {
                                ...
                                CodigoDeBaja = datos.codigoOperacion.ToString(CultureInfo.InvariantCulture),
                                Fecha = DateTime.Parse(datos.fechaHora),
