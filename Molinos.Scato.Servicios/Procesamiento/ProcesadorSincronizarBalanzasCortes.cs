...
namespace Molinos.Scato.Servicios.Procesamiento
{
    ...
    public class ProcesadorSincronizarBalanzasCortes : ProcesadorModificar<SincronizarBalanzasCortes>
    {
        ...
        //            cargaPlanillaSolido = Repositorio.Listar<Carga>(x => vapor_id == x.Vapor.Id && x.FechaInicio > fechaInicio && x.CargaOpuesta_Id > 0 && x.ToneladasAW != 0).OrderByDescending(x=>x.Fecha).ToList();
        //        else
        //            cargaPlanillaSolido = Repositorio.Listar<Carga>(x => vapor_id == x.Vapor.Id && 
        //            x.CargaOpuesta_Id > 0 && x.ToneladasAW != 0 && x.FechaInicio > ultimaFecha);
        //        #endregion
        ...
        //                    //var moduloTurnoDb = Repositorio.Listar<ModuloDeCargaPlanillaDeTurnos>(x => x.TurnoPuerto.Id == turnoInicial.idTurno &&
        ...
        //            moduloTurnoDb1.Fecha = fechaCarga;
