    ...
    public class ProcesadorArmarCuerpoMailDocumentos : ProcesadorComando<ArmarCuerpoMailDocumentos>
    {
        ...
        public override Resultado Ejecutar(ArmarCuerpoMailDocumentos comando)
        {
            ...
            try
            {
                ...
                .Where(nd => 
                    nd.Documento.DocumentoTipo.Nombre == "A solicitar en la nominación" && 
                    nd.NominacionDocumentoEstado.Estado != "Documento Cerrado" &&
                    nd.ConfiguracionDocumento.Nominacion.FechaEliminacion == null
                )
                .Select(nd => new
                {
