...
namespace Molinos.Scato.Servicios.Procesamiento
{
    public class ProcesadorValidarStock : ProcesadorComando<ValidarStock>
    {
        ...
        public decimal SaldoStock(ValidarStock comando, Recorrido recorrido)
        {
            ...
            var pesosNeto = Repositorio.Sumar<Stock>(x => x.Cantidad, x => x.Proveedor.Id == recorrido.Vehiculo.CartaPorte.Destinatario.Id && x.Material.Id == recorrido.Material.Id && !x.Recorrido.Rechazado);
            return pesosNeto;
        }
