...
{
    [TestFixture]
    public class RefrescarOrdenCargaInternaTest
    {
        private Scato.Actividades.Internas.RefrescarOrdenCargaInterna target;
        ...
        public void SetUp()
        {
            target = new Scato.Actividades.Internas.RefrescarOrdenCargaInterna();
        ...
        public void TestRefrescar()
        {
            ...
            srvRepositorio.Setup(s => s.ObtenerOrdenCargaInternaPorInstanceId(It.IsAny<Guid>())).Returns(new OrdenCargaInternaDto { Id = 1 });
            ...
            var orden = resultado.First(f => f.Key == "Orden").Value as OrdenCargaInternaDto;
