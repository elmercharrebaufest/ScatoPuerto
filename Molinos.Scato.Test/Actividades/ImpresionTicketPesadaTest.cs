...
namespace Molinos.Scato.Test.Actividades
{
    ...
    public class ImpresionTicketPesadaTest
    {
        ...
        public void SetUp()
        {
            ...
            target = new ImpresionTicketPesada();
            ...
            servcomando.Setup(s => s.Ejecutar(It.IsAny<ImprimirTicketPesada>())).Returns(new Resultado());
        ...
        public void ExecuteTest()
        {
            ...
            servcomando.Verify(s => s.Ejecutar(It.IsAny<ImprimirTicketPesada>()), Times.Once());
        ...
        public void ExecuteExceptionsTest()
        {
            ...
            servcomando.Setup(s => s.Ejecutar(It.IsAny<ImprimirTicketPesada>())).Throws(new Exception("Error"));
        ...
        public void ExecuteExceptionsDocumentoNullTest()
        {
            ...
            Assert.AreEqual(((Resultado)resultado).Errores.First(x => x.Key == "").Value, "Error en la carga del log. El mismo no fue almacenado.");
            servcomando.Verify(s => s.Ejecutar(It.IsAny<ImprimirTicketPesada>()), Times.Never());
            servcomando.Verify(s => s.Ejecutar(It.IsAny<FinDeActividad>()), Times.Once());
            servcomando.Verify(s => s.Ejecutar(It.IsAny<CrearLogActividad>()), Times.Once());
        }
    }
