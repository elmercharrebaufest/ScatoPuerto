...
namespace Molinos.Scato.Test.Actividades
{
    ...
    public class VerificarCorrespondeImprimirReciboMunicipalTest
    {
        ...
        public void TestVerificarCorrespondeImprimirReciboMunicipal()
        {
            ...
            srvRepositorio.Setup(s => s.BuscarMaterialesPorCentro(It.IsAny<int>(), It.IsAny<string>())).Returns(new List<MaterialPorCentroDto> { new MaterialPorCentroDto() { Id = 1, CentroId = 1, MaterialId = 1 } });
