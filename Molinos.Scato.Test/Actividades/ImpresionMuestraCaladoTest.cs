...
namespace Molinos.Scato.Test.Actividades
{
    ...
    public class ImpresionMuestraCaladoTest
    {
        ...
        public void SetUp()
        {
            ...
            target = new ImpresionMuestraCalado();
            ...
            servcomando.Setup(s => s.Ejecutar(It.IsAny<ImprimirMuestraCalado>())).Returns(new Resultado());
            ...
            host.InArguments.NombreUsuario = "wandino";
            host.InArguments.PesoNeto = "45000";
            host.InArguments.PuestoDeTrabajoId = 1;
            host.InArguments.Procedencia = "Procedencia";
            host.InArguments.NumeroCartaPorte = "1234123456789012";
        ...
        public void ExecuteTest()
        {
            ...
            servcomando.Verify(s => s.Ejecutar(It.IsAny<ImprimirMuestraCalado>()), Times.Once());
        ...
        public void ExecuteExceptionsTest()
        {
            ...
            servcomando.Setup(s => s.Ejecutar(It.IsAny<ImprimirMuestraCalado>())).Throws(new Exception("Error"));
        ...
        public void ExecuteExceptionsDocumentoNullTest()
        {
            ...
            Assert.AreEqual(((Resultado)resultado).Errores.First(x => x.Key == "").Value, "Error en la carga del log. El mismo no fue almacenado.");
            servcomando.Verify(s => s.Ejecutar(It.IsAny<ImprimirMuestraCalado>()), Times.Never());
            servcomando.Verify(s => s.Ejecutar(It.IsAny<FinDeActividad>()), Times.Once());
            servcomando.Verify(s => s.Ejecutar(It.IsAny<CrearLogActividad>()), Times.Once());
        }
    }
