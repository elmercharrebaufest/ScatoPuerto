...
{
    [TestFixture]
    public class MarcarWorkflowTerminadoTest
    {
        private MarcarWorkflowTerminado target;
        ...
        public void SetUp()
        {
            target = new MarcarWorkflowTerminado();
        ...
        public void TestControlRecorrido()
        {
            ...
            srvRepositorio.Setup(s => s.ObtenerRecorridoPorGuid(It.IsAny<Guid>())).Returns(new RecorridoDto {Id = 1});
