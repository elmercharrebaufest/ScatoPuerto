...
namespace Molinos.Scato.Test.Actividades
{
    ...
    class ImpresionAsignacionDeRutaTest
    {
        ...
        public void SetUp()
        {
            ...
            target = new ImpresionAsignacionDeRuta();
            ...
            servcomando.Setup(s => s.Ejecutar(It.IsAny<ImprimirAsignacionDeRuta>())).Returns(new Resultado());
            ...
            host.InArguments.Calidad = "45000";
        ...
        public void ExecuteTest()
        {
            ...
            servcomando.Verify(s => s.Ejecutar(It.IsAny<ImprimirAsignacionDeRuta>()), Times.Once());
        ...
        public void ExecuteExceptionsTest()
        {
            ...
            servcomando.Setup(s => s.Ejecutar(It.IsAny<ImprimirAsignacionDeRuta>())).Throws(new Exception("Error"));
        ...
        public void ExecuteExceptionsDocumentoNullTest()
        {
            ...
            Assert.AreEqual(((Resultado)resultado).Errores.First(x => x.Key == "").Value, "Error en la carga del log. El mismo no fue almacenado.");
            servcomando.Verify(s => s.Ejecutar(It.IsAny<ImprimirAsignacionDeRuta>()), Times.Never());
            servcomando.Verify(s => s.Ejecutar(It.IsAny<FinDeActividad>()), Times.Once());
            servcomando.Verify(s => s.Ejecutar(It.IsAny<CrearLogActividad>()), Times.Once());
        }
    }
