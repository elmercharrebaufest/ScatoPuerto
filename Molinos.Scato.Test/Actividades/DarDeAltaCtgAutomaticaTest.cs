...
{
    [TestFixture]
    public class DarDeAltaCtgAutomaticaTest
    {
        private Scato.Actividades.Internas.DarDeAltaCtgAutomatica target;
        ...
        public void SetUp()
        {
            target = new Scato.Actividades.Internas.DarDeAltaCtgAutomatica();
        ...
        [Test]
        public void TestDarDeAltaCtgAutomatica()
        {
