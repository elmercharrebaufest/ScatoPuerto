...
{
    [TestFixture]
    public class RegistrarMuestreoYPesajeTransmisionAMonsantoAsincronicoTest
    {
        private RegistrarMuestreoYPesajeTransmisionAMonsantoAsincronico target;
        ...
        public void SetUp()
        {
            target = new RegistrarMuestreoYPesajeTransmisionAMonsantoAsincronico();
        ...
        {
            var dto = new MuestreoPesajeTransporteAutomotor() { cuitLaboratorio = "12341232"};
