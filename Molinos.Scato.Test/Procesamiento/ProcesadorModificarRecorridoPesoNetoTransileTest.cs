...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoPesoNetoTransileTest
    {
        private ProcesadorModificarRecorridoPesoNetoTransile target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoPesoNetoTransile(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoPesoNetoTransile { InstanceId = new Guid(), PesoAgregado = 30000 });
