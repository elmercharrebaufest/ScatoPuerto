...
{
    [TestFixture]
    public class ProcesadorCrearPesoMaximoPorTipoVehiculoTest
    {
        private ProcesadorCrearPesoMaximoPorTipoVehiculo target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorCrearPesoMaximoPorTipoVehiculo(repositorioMock.Object, conversor, new NullLogger());
        ...
        {
            var comando = new CrearPesoMaximoPorTipoVehiculo() { Dto = tipoDto };
            var resultado = target.Ejecutar(comando);
            repositorioMock.Verify(s => s.Agregar(It.Is<PesoMaximoPorTipoVehiculo>(o => o.TipoVehiculo == tipoDto.TipoVehiculo)), Times.Exactly(1));
        ...
        public void TestCrearEntidadInvalidoPorCodigo()
        {
            ...
            var comando = new CrearPesoMaximoPorTipoVehiculo() { Dto = tipoDto };
            var resultado = target.Ejecutar(comando);
            repositorioMock.Verify(s => s.Agregar(It.IsAny<PesoMaximoPorTipoVehiculo>()), Times.Never());
        ...
        [Test]
        public void TestCrearEntidadValidoParaOtroCentro()
        {
            var tiposExistentes = new List<PesoMaximoPorTipoVehiculo>
                {
                    new PesoMaximoPorTipoVehiculo() {Id = 5, TipoVehiculo = TipoVehiculo.Camión, Centro = new Centro{Id = 1}},
            ...
            var comando = new CrearPesoMaximoPorTipoVehiculo() { Dto = tipoDto };
            var resultado = target.Ejecutar(comando);
            repositorioMock.Verify(s => s.Agregar(It.IsAny<PesoMaximoPorTipoVehiculo>()), Times.Exactly(1));
            repositorioMock.Verify(s => s.GuardarCambios(), Times.Exactly(1));
            Assert.That(resultado, Is.Not.Null);
            Assert.That(resultado.HayErrores, Is.EqualTo(false));
