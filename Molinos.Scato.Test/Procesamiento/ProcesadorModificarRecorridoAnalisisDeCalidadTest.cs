...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoAnalisisDeCalidadTest
    {
        private ProcesadorModificarRecorridoAnalisisDeCalidad target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoAnalisisDeCalidad(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoAnalisisDeCalidad { InstanceId = new Guid() });
