...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoDatosProximaActividadTest
    {
        private ProcesadorModificarRecorridoDatosProximaActividad target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoDatosProximaActividad(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoDatosProximaActividad { InstanceId = new Guid(), DatosProximaActividad = "Bruto" });
