...
{
    [TestFixture]
    public class ProcesadorCrearHojaDeRutaYerbateraTest
    {
        private ProcesadorCrearHojaDeRutaYerbatera target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorCrearHojaDeRutaYerbatera(repositorioMock.Object, conversor, new NullLogger());
        ...
        public void TestNoEncontroWf()
        {
            ...
            var comando = new CrearHojaDeRutaYerbatera { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000") };
            ...
            repositorioMock.Verify(s => s.Agregar(It.IsAny<HojaDeRutaYerbatera>()), Times.Never());
        ...
        public void TestCrear()
        {
            ...
            var comando = new CrearHojaDeRutaYerbatera { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000"), CentroId = 3 };
            ...
            repositorioMock.Setup(s => s.Obtener(It.IsAny<Expression<Func<Workflow, bool>>>()))
                    .Returns<Expression<Func<Workflow, bool>>>(q => workflows.Where((q.Compile())).SingleOrDefault());
            var resultado = target.Ejecutar(comando);
            repositorioMock.Verify(s => s.Agregar(It.Is<HojaDeRutaYerbatera>(o => o.Chofer.Id == dto.Chofer.Id && o.Recorrido.InstanciaWorkflow == comando.InstanciaWorkflowId && o.Recorrido.Workflow.Codigo == "W1" && o.Recorrido.Centro.Id == comando.CentroId && o.Recorrido.Chofer.Id == dto.Chofer.Id && o.Recorrido.Transportista.Id == dto.TransportistaId && o.Recorrido.TipoComercial.Id == dto.TipoComercialId)), Times.Exactly(1));
