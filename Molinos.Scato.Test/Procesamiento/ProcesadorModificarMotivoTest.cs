...
{
    [TestFixture]
    public class ProcesadorModificarMotivoTest
    {
        private ProcesadorModificarMotivo target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorModificarMotivo(repositorioMock.Object, conversorMock.Object, new NullLogger());
        ...
        {
            repositorioMock.Setup(s => s.Obtener<Motivo>(It.IsAny<int>())).Returns(tipo);
            var comando = new ModificarMotivo{Dto = tipoDto};
            var resultado = target.Ejecutar(comando);
            conversorMock.Verify(s => s.Convertir(It.IsAny<MotivoDto>(), It.IsAny<Motivo>()), Times.Exactly(1));
