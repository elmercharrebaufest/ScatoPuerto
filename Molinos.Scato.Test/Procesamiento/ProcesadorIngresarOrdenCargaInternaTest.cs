...
{
    [TestFixture]
    public class ProcesadorIngresarOrdenCargaInternaTest
    {
        private ProcesadorIngresarOrdenCargaInterna target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorIngresarOrdenCargaInterna(repositorioMock.Object, conversor, new NullLogger());
        ...
        public void TestNoEncontroWf()
        {
            ...
            var comando = new CrearOrdenCargaInterna { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000") };
            ...
            repositorioMock.Verify(s => s.Agregar(It.IsAny<OrdenCargaInterna>()), Times.Never());
        ...
        public void TestCrear()
        {
            ...
            var comando = new CrearOrdenCargaInterna { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000"), CentroId = 3};
            ...
            repositorioMock.Verify(s => s.Agregar(It.Is<OrdenCargaInterna>(o => o.Chofer.Id == dto.Chofer.Id && o.Destino.Id == dto.DestinoId && o.PatenteCamion == dto.PatenteCamion)), Times.Exactly(1));
