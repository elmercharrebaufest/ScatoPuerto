...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoControlBalanzaTest
    {
        private ProcesadorModificarRecorridoControlBalanza target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoControlBalanza(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoControlBalanza { InstanceId = new Guid(), ControlBalanza = true });
        ...
        public void TestModificarError()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoControlBalanza { InstanceId = new Guid() });
