...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoCaladoTest
    {
        private ProcesadorModificarRecorridoCalado target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoCalado(repositorioMock.Object, conversorMock.Object, log);
            ...
            calado = new CaladoDto
                {
                    ...
                    CicloDeCalado = 2,
                    MuestraConjunto = 10,
                    WorkflowInstanceId = new Guid("25892e17-80f6-415f-9c65-7395632f0223"),
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoCalado { WorkflowInstanceId = new Guid()});
            repositorioMock.Verify(v => v.GuardarCambios(), Times.Once());
            Assert.That(resultado.HayErrores, Is.EqualTo(false));
        }

        private void Expression<T>()
        {
