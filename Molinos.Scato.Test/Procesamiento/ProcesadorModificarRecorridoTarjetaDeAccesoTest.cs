...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoTarjetaDeAccesoTest
    {
        private ProcesadorModificarRecorridoTarjetaDeAcceso target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoTarjetaDeAcceso(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoTarjetaDeAcceso { InstanceId = new Guid(), Numero = "100000"});
            repositorioMock.Verify(v => v.GuardarCambios(), Times.Once());
            repositorioMock.Verify(v => v.Obtener<Almacen>(It.IsAny<int>()), Times.Never());
        ...
        public void TestModificarError()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoTarjetaDeAcceso { InstanceId = new Guid(), Numero = "200000" });
