...
{
    [TestFixture]
    public class ProcesadorCrearOrdenDeCargaContenedorTest
    {
        private ProcesadorCrearOrdenDeCargaContenedor target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorCrearOrdenDeCargaContenedor(repositorioMock.Object, conversor, new NullLogger());
        ...
        public void TestNoEncontroWf()
        {
            ...
            var comando = new CrearOrdenDeCargaContenedor() { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000") };
        ...
        public void TestCrear()
        {
            ...
            var comando = new CrearOrdenDeCargaContenedor { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000"), CentroId = 3 };
