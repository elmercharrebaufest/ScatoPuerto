...
{
    [TestFixture]
    public class ProcesadorModificarOrdenCargaFasTest
    {
        private ProcesadorModificarOrdenCargaFas target;
        private Mock<IRepositorio> repositorioMock;
        private IConversor conversor;
        private OrdenCargaFasDto dto;
        private OrdenCargaFas cargaFas;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorModificarOrdenCargaFas(repositorioMock.Object, conversor, new NullLogger());
            ...
            cargaFas = new OrdenCargaFas
                {
                    Chofer = new Chofer { Id = 1, Nombre = "E", Apellido = "A"},
        ...
        public void TestCrear()
        {
            ...
            var comando = new ModificarOrdenCargaFas { Orden = dto};
            repositorioMock.Setup(s => s.Obtener<OrdenCargaFas>(It.IsAny<int>())).Returns(cargaFas);
            ...
            repositorioMock.Setup(s => s.Existe(It.IsAny<Expression<Func<OrdenCargaFas, bool>>>())).Returns(false);
