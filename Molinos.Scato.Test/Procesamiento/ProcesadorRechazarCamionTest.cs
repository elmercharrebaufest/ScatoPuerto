...
{
    [TestFixture]
    public class ProcesadorRechazarCamionTest
    {
        private ProcesadorRechazarCamion target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorRechazarCamion(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new RechazarCamion { WorkflowId = new Guid()});
