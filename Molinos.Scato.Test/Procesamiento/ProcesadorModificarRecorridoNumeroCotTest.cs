...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoNumeroCotTest
    {
        private ProcesadorModificarRecorridoNumeroCot target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoNumeroCot(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoNumeroCot() { InstanceId = new Guid(), NumeroCot = "12345"});
