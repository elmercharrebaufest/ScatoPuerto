...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoMuestraAuditoriaTest
    {
        private ProcesadorModificarRecorridoMuestraAuditoria target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoMuestraAuditoria(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoMuestraAuditoria() { InstanceId = new Guid() });
