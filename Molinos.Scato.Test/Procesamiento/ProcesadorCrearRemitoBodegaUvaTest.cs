...
{
    [TestFixture]
    public class ProcesadorCrearRemitoBodegaUvaTest
    {
        private ProcesadorCrearRemitoBodegaUva target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorCrearRemitoBodegaUva(repositorioMock.Object, conversor, new NullLogger());
            dto = new RemitoBodegaUvaDto
            {
                ...
                Patente = "ABC999",
                DescargasDeBines = new List<DescargaDeBinesDto>()
            };
        }
        ...
        public void TestNoEncontroWf()
        {
            ...
            var comando = new CrearRemitoBodegaUva { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000") };
            ...
            repositorioMock.Verify(s => s.Agregar(It.IsAny<RemitoBodegaUva>()), Times.Never());
        ...
        [Test]
        public void TestCrearRemitoBodegaUva()
        {
            var workflows = new List<Workflow> { new Workflow { Id = 1, Codigo = "W1", Descripcion = "D1" } };
            var comando = new CrearRemitoBodegaUva { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000"), CentroId = 3 };
            ...
            repositorioMock.Verify(s => s.Agregar(It.Is<RemitoBodegaUva>(r => r.NroRemito == comando.Orden.NroRemito)), Times.Exactly(1));
