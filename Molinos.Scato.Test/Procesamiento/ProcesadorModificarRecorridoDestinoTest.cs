...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoDestinoTest
    {
        private ProcesadorModificarRecorridoDestino target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoDestino(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoDestino {InstanceId = new Guid(), AlmacenId = 1});
        ...
        [Test]
        public void TestModificarAlmacen()
        {
