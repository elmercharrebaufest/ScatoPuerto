...
{
    [TestFixture]
    public class ProcesadorCrearHojaDeRutaTest
    {
        private ProcesadorCrearHojaDeRuta target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorCrearHojaDeRuta(repositorioMock.Object, conversor, new NullLogger());
        ...
        public void TestNoEncontroWf()
        {
            ...
            var comando = new CrearHojaDeRuta { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000") };
            ...
            repositorioMock.Verify(s => s.Agregar(It.IsAny<HojaDeRuta>()), Times.Never());
        ...
        public void TestCrear()
        {
            ...
            var comando = new CrearHojaDeRuta { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000"), CentroId = 3 };
            ...
            repositorioMock.Verify(s => s.Agregar(It.Is<HojaDeRuta>(o => o.Chofer.Id == dto.Chofer.Id)), Times.Exactly(1));
