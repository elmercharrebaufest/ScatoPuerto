...
{
    [TestFixture]
    public class ProcesadorCrearControlDeTiempoTest
    {
        private ProcesadorCrearControlDeTiempo target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorCrearControlDeTiempo(repositorioMock.Object, conversorMock.Object, new NullLogger());
        ...
        public void TestCrearEntidad()
        {
            ...
            var comando = new CrearControlDeTiempo() {Dto = dto};
            var resultado = target.Ejecutar(comando);
            repositorioMock.Verify(s => s.Agregar(It.Is<ControlDeTiempo>(x => x.Id == 0)), Times.Exactly(1));
