...
{
    [TestFixture]
    public class ProcesadorEliminarAjusteStockBinesTest
    {
        private ProcesadorEliminarAjusteStockBines target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorEliminarAjusteStockBines(servRepositorio.Object, conversor, new NullLogger());
        ...
        {
            servRepositorio.Setup(x => x.Obtener<AjusteStockBines>(It.IsAny<int>())).Returns(new AjusteStockBines());

            var comando = new EliminarAjusteStockBines{Id = dto.Id};
            var resultado = target.Ejecutar(comando);
            servRepositorio.Verify(s => s.Remover(It.IsAny<AjusteStockBines>()), Times.Exactly(1));
