...
{
    [TestFixture]
    public class ProcesadorModificarRecorridoTerminadoTest
    {
        private ProcesadorModificarRecorridoTerminado target;
        ...
        public void SetUp()
        {
            ...
            log = new NullLogger();
            target = new ProcesadorModificarRecorridoTerminado(repositorioMock.Object, conversorMock.Object, log);
        ...
        public void TestModificar()
        {
            ...
            var resultado = target.Ejecutar(new ModificarRecorridoTerminado { InstanceId = new Guid()});
