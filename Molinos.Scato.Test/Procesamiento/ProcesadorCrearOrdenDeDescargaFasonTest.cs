...
{
    [TestFixture]
    public class ProcesadorCrearOrdenDeDescargaFasonTest
    {
        private ProcesadorCrearOrdenDeDescargaFason target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorCrearOrdenDeDescargaFason(repositorioMock.Object, conversor, new NullLogger());
        ...
        public void TestNoEncontroWf()
        {
            ...
            var comando = new CrearOrdenDeDescargaFason { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000") };
            ...
            repositorioMock.Verify(s => s.Agregar(It.IsAny<OrdenDeDescargaFason>()), Times.Never());
        ...
        public void TestCrear()
        {
            ...
            var comando = new CrearOrdenDeDescargaFason { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000"), CentroId = 3 };
            ...
            repositorioMock.Verify(s => s.Agregar(It.Is<OrdenDeDescargaFason>(o => o.Chofer.Id == dto.Chofer.Id)), Times.Exactly(1));
