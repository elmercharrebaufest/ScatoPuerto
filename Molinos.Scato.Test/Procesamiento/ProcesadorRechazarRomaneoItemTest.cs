...
{
    [TestFixture]
    public class ProcesadorRechazarDescargaUnidadItemTest
    {
        private ProcesadorRechazarDescargaUnidadItem target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorRechazarDescargaUnidadItem(repositorioMock.Object, conversor, new NullLogger(), servicioSapMock.Object);
        ...
        public void TestEjecutar()
        {
            ...
            repositorioMock.Setup(s => s.Obtener<DescargaUnidadItem>(It.IsAny<int>())).Returns(new DescargaUnidadItem { DocMaterial = "asd", EjercicioDocMaterial = "qwe" });
            repositorioMock.Setup(s => s.Obtener<DescargaUnidad>(It.IsAny<int>())).Returns(descargaUnidad);
            var comando = new RechazarDescargaUnidadItem() { Dto = new List<DescargaUnidadItemDto> { itemDto } };
