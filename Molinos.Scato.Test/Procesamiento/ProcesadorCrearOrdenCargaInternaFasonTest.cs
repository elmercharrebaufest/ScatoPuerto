...
{
    [TestFixture]
    public class ProcesadorCrearOrdenCargaInternaFasonTest
    {
        private ProcesadorCrearOrdenCargaInternaFason target;
        ...
        public void SetUp()
        {
            ...
            target = new ProcesadorCrearOrdenCargaInternaFason(repositorioMock.Object, conversor, new NullLogger());
        ...
        public void TestNoEncontroWf()
        {
            ...
            var comando = new CrearOrdenCargaInternaFason { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000") };
            ...
            repositorioMock.Verify(s => s.Agregar(It.IsAny<OrdenCargaInternaFason>()), Times.Never());
        ...
        public void TestCrear()
        {
            ...
            var comando = new CrearOrdenCargaInternaFason { Orden = dto, NombreWorkflow = "W1", InstanciaWorkflowId = new Guid("00000000-0000-0000-0000-000000000000"), CentroId = 3 };
            ...
            repositorioMock.Verify(s => s.Agregar(It.Is<OrdenCargaInternaFason>(o => o.Chofer.Id == dto.Chofer.Id && o.PatenteCamion == dto.PatenteCamion)), Times.Exactly(1));
