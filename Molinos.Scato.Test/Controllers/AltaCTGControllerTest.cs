...
namespace Molinos.Scato.Test.Controllers
{
    ...
    public class AltaCTGControllerTest
    {
        ...
        public void SetUp()
        {
            ...
            model = new AltaCTGDto { WorkflowId = Guid.NewGuid(), TarifaReferencia = 1, CodigoCTG = "A" };
            ...
            contract.Setup(
                ...
                s.AltaCTG(It.IsAny<Guid>(), It.IsAny<DecisionCtg>(), It.IsAny<string>(), It.IsAny<decimal>(),
                          It.IsAny<ControlRecorridoDto>())).Returns(new Resultado());
        ...
        public void CargarAltaCtgModeloValidoConErrores()
        {
            ...
            contract.Setup(
                s =>
                s.AltaCTG(It.IsAny<Guid>(), It.IsAny<DecisionCtg>(), It.IsAny<string>(), It.IsAny<decimal>(),
                          It.IsAny<ControlRecorridoDto>())).Returns(resultado);
