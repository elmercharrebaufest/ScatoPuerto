...
namespace Molinos.Scato.Test.Controllers
{
    ...
    [TestFixture]
    public class CargarCartaPortePrestamoControllerTest
    {
        private CargarCartaPortePrestamoController target;
        ...
        public void SetUp()
        {
            ...
            target = new CargarCartaPortePrestamoController(logger, servRepositorioMock.Object, actFactoryMock.Object, servComandosMock.Object, listaMock.Object, configuracion.Object, servicioSap.Object, null);
        ...
        public void TestIndex()
        {
            ...
            servRepositorioMock.Setup(s => s.ObtenerCentro(It.IsAny<int>()))
                    .Returns(new CentroDto { Id = 1, Descripcion = "Proveedor 1", RequiereCupo = false });
