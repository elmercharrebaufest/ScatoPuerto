...
{
    [TestFixture]
    public class ServicioSapMov975ControllerTest
    {
        private ServicioSapMov975Controller target;
        private Mock<IServicioActividadFactory<IServicioSapMov975Service>> factory;
        private Mock<IServicioSapMov975Service> contract;
        ...
        public void SetUp()
        {
            factory = new Mock<IServicioActividadFactory<IServicioSapMov975Service>>();
            contract = new Mock<IServicioSapMov975Service>();
            ...
            contract.Setup(
                s => s.ServicioSapMov975(It.IsAny<Guid>(), It.IsAny<bool>(), It.IsAny<ControlRecorridoDto>()))
                    .Returns(new Resultado());
            target = new ServicioSapMov975Controller(log, factory.Object, servRepositorio.Object);
