...
namespace Molinos.Scato.Test.Controllers
{
    ...
    [TestFixture]
    public class ServicioSapEgresosNoProductivosControllerTest
    {
        private Mock<IServicioRepositorio> servRepositorio;
        private Mock<IServicioComandos> servComando;
        private Mock<IServicioActividadFactory<IServicioSapEgresosNoProductivosService>> factory;
        private Mock<IServicioSapEgresosNoProductivosService> contract;
        private NullLogger log;
        private ServicioSapEgresosNoProductivosController target;
        ...
        public void SetUp()
        {
            ...
            factory = new Mock<IServicioActividadFactory<IServicioSapEgresosNoProductivosService>>();
            log = new NullLogger();
            contract = new Mock<IServicioSapEgresosNoProductivosService>();
            target = new ServicioSapEgresosNoProductivosController(log,factory.Object,servRepositorio.Object);
        ...
        public void EncolarErrorTest()
        {
            ...
            contract.Setup(
                c =>
                c.ServicioSapEgresosNoProductivos(It.IsAny<Guid>(), It.IsAny<bool>(), It.IsAny<ControlRecorridoDto>()))
                    .Returns(r);
