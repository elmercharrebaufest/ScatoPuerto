...
namespace Molinos.Scato.Test.Controllers
{
    ...
    [TestFixture]
    public class ControlPesoOrigenControllerTest
    {
        private ControlPesoOrigenController target;
        private Mock<IServicioRepositorio> servRepositorioMock;
        private Mock<IServicioActividadFactory<IControlPesoOrigenService>> actFactoryMock;
        private Mock<IControlPesoOrigenService> contractMock;
        ...
        public void SetUp()
        {
            ...
            actFactoryMock = new Mock<IServicioActividadFactory<IControlPesoOrigenService>>();
            contractMock = new Mock<IControlPesoOrigenService>();
            target = new ControlPesoOrigenController(new NullLogger(), actFactoryMock.Object, servRepositorioMock.Object);
        ...
        [Test]
        public void TestControlPesoOrigen()
        {
            actFactoryMock.Setup(s => s.CrearServicio(It.IsAny<int>())).Returns(contractMock.Object);
            contractMock.Setup(s => s.ControlPesoOrigen(It.IsAny<ControlRecorridoDto>(), It.IsAny<Guid>())).Returns(new Resultado());
