...
namespace Molinos.Scato.Test.Controllers
{
    ...
    public class AsignacionDeEstablecimientoControllerTest
    {
        ...
        public void SetUp()
        {
            ...
            target = new AsignacionDeEstablecimientoController(logger, actFactoryMock.Object, servRepositorioMock.Object);
        ...
        public void TestIndexPost()
        {
            ...
            contractMock.Setup(s => s.AsignacionDeEstablecimiento(It.IsAny<Guid>(), It.IsAny<int>(), It.IsAny<ControlRecorridoDto>())).Returns(new Resultado());
            ...
            contractMock.Verify(v => v.AsignacionDeEstablecimiento(It.IsAny<Guid>(), It.IsAny<int>(), It.IsAny<ControlRecorridoDto>()), Times.Once());
        }
        ...
        public void TransportistaRechazadoErrorTest()
        {
            ...
            actFactoryMock.Setup(s => s.CrearServicio(It.IsAny<int>())).Returns(contractMock.Object);
            contractMock.Setup(s => s.AsignacionDeEstablecimiento(It.IsAny<Guid>(), It.IsAny<int?>(), It.IsAny<ControlRecorridoDto>())).Returns(resultado);
            var controlRecorrido = new ControlRecorridoDto { WorkflowInstanceId = Guid.NewGuid() };
            var result = target.TransportistaRechazado("w", 1, controlRecorrido.WorkflowInstanceId, controlRecorrido) as RedirectToRouteResult;
