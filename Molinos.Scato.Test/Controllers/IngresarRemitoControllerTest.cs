...
namespace Molinos.Scato.Test.Controllers
{
    ...
    [TestFixture]
    public class IngresarRemitoControllerTest
    {
        private IngresoRemitoController target;
        private Mock<IServicioRepositorio> servRepositorioMock;
        private Mock<IServicioComandos> servComandosMock;
        private Mock<IServicioActividadFactory<IIngresoRemitoService>> actFactoryMock;
        private Mock<IIngresoRemitoService> contractMock;
        ...
        public void SetUp()
        {
            ...
            actFactoryMock = new Mock<IServicioActividadFactory<IIngresoRemitoService>>();
            contractMock = new Mock<IIngresoRemitoService>();
            listaMock = new Mock<IListaDeWorkflows>();
            logger = new NullLogger();
            target = new IngresoRemitoController(logger, servRepositorioMock.Object, actFactoryMock.Object, servComandosMock.Object, listaMock.Object);
            ...
            contractMock.Setup(s => s.IngresoRemito(dto, It.IsAny<int>(), workflow, It.IsAny<int>(), It.IsAny<string>(), It.IsAny<ControlRecorridoDto>())).Returns(new ResultadoCrearWorkflow { InstanciaWorkflowId = instanciaWfId });
        }
        ...
        public void TestIndex()
        {
            ...
            Assert.That(model.EsRemitoProveedor, Is.EqualTo(false));
