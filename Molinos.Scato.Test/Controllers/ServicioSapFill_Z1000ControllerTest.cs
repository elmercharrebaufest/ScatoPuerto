...
namespace Molinos.Scato.Test.Controllers
{
    ...
    [TestFixture]
    public class ServicioSapFill_Z1000ControllerTest
    {
        private ServicioSapFill_Z1000Controller target;
        private Mock<IServicioActividadFactory<IServicioSapFill_Z1000Service>> factory;
        private Mock<IServicioSapFill_Z1000Service> contract;
        private Mock<IServicioRepositorio> servRepositorio;
        private NullLogger log;
        private IngresosPorCompraDeGranosTransmisionASapDto model;
        private DatosUsuario usuario;

        [SetUp]
        public void SetUp()
        {
            factory = new Mock<IServicioActividadFactory<IServicioSapFill_Z1000Service>>();
            contract = new Mock<IServicioSapFill_Z1000Service>();
            ...
            model = new IngresosPorCompraDeGranosTransmisionASapDto
                {
            ...
            contract.Setup(
                s => s.ServicioSapFill_Z1000(It.IsAny<Guid>(), It.IsAny<bool>(), It.IsAny<ControlRecorridoDto>()))
                    .Returns(new Resultado());
            target = new ServicioSapFill_Z1000Controller(log, factory.Object, servRepositorio.Object);
