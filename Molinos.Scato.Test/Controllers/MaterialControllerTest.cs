...
namespace Molinos.Scato.Test.Controllers
{
    ...
    public class MaterialControllerTest
    {
        ...
        public void TestCrearPost()
        {
            ...
            var result = target.Crear(datosUsuario, materiales[0], 1, 1, 1, false, false, false, emptyJson, emptyJson, 1, true, "soja", 0,false,false) as ContentResult;
        ...
        public void TestCrearPostInvalido()
        {
            ...
            var result = target.Crear(datosUsuario, materiales[0], 1, 1, 1, false, false, false, emptyJson, emptyJson, 1, false ,"soja",0 ,false,false) as ViewResult;
        ...
        public void TestModificarPost()
        {
            ...
            var result = target.Modificar(new DatosUsuario { CentroId = 1 }, materialDto, 1, 1, 1, false, false, false, "[]", "[]", 1, false, false, "soja", 1,false, 0) as ContentResult;
            var expectedResult = new ContentResult { Content = "ajax-edit-success" };
            servComandosMock.Verify(p => p.Ejecutar(It.IsAny<Comando>()), Times.Exactly(1));
            Assert.NotNull(result);
            Assert.AreEqual(result.Content, expectedResult.Content);
        ...
        public void TestModificarPostInvalido()
        {
            ...
            var result = target.Modificar(new DatosUsuario { CentroId = 1 }, materialDto, 1, 1, 1, false, false, false, "", "", 1, false, false, "soja",1, false, 0) as ViewResult;
