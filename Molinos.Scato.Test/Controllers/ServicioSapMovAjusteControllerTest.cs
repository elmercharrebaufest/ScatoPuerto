...
{
    [TestFixture]
    public class ServicioSapMovAjusteControllerTest
    {
        private ServicioSapMovAjusteController target;
        private Mock<IServicioActividadFactory<IServicioSapMovAjusteService>> factory;
        private Mock<IServicioSapMovAjusteService> contract;
        private Mock<IServicioRepositorio> servRepositorio;
        private NullLogger log;
        private MovimientoStockSapDto model;
        private DatosUsuario usuario;

        [SetUp]
        public void SetUp()
        {
            factory = new Mock<IServicioActividadFactory<IServicioSapMovAjusteService>>();
            contract = new Mock<IServicioSapMovAjusteService>();
            ...
            model = new MovimientoStockSapDto {WorkflowCodigo = "W", WorkflowId = Guid.NewGuid()};
            ...
            contract.Setup(
                s => s.ServicioSapMovAjuste(It.IsAny<Guid>(), It.IsAny<bool>(), It.IsAny<ControlRecorridoDto>()))
                    .Returns(new Resultado());
            target = new ServicioSapMovAjusteController(log, factory.Object, servRepositorio.Object);
