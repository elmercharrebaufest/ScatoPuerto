...
{
    [TestFixture]
    public class ServicioSapMov305ControllerTest
    {
        private ServicioSapMov305Controller target;
        private Mock<IServicioActividadFactory<IServicioSapMov305Service>> factory;
        private Mock<IServicioSapMov305Service> contract;
        private Mock<IServicioRepositorio> servRepositorio;
        private NullLogger log;
        private LlegadaADestinoEnRedespachosTransmisionASapDto model;
        private DatosUsuario usuario;

        [SetUp]
        public void SetUp()
        {
            factory = new Mock<IServicioActividadFactory<IServicioSapMov305Service>>();
            contract = new Mock<IServicioSapMov305Service>();
            ...
            model = new LlegadaADestinoEnRedespachosTransmisionASapDto{WorkflowCodigo = "W",WorkflowId = Guid.NewGuid()};
            ...
            contract.Setup(
                s => s.ServicioSapMov305(It.IsAny<Guid>(), It.IsAny<bool>(), It.IsAny<ControlRecorridoDto>()))
                    .Returns(new Resultado());
            target = new ServicioSapMov305Controller(log, factory.Object, servRepositorio.Object);
