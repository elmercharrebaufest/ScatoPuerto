...
namespace Molinos.Scato.Test.Controllers
{
    ...
    [TestFixture]
    public class ServicioSapZE7550ControllerTest
    {
        private ServicioSapZE7550Controller target;
        private Mock<IServicioActividadFactory<IServicioSapZE7550Service>> factory;
        private Mock<IServicioSapZE7550Service> contract;
        ...
        public void SetUp()
        {
            factory = new Mock<IServicioActividadFactory<IServicioSapZE7550Service>>();
            contract = new Mock<IServicioSapZE7550Service>();
            ...
            contract.Setup(
                s => s.ServicioSapZE7550(It.IsAny<Guid>(), It.IsAny<bool>(), It.IsAny<ControlRecorridoDto>()))
                    .Returns(new Resultado());
            target = new ServicioSapZE7550Controller(log, factory.Object, servRepositorio.Object);
