...
{
    [TestFixture]
    public class ServicioSapPesaNetoControllerTest
    {
        private ServicioSapPesaNetoController target;
        private Mock<IServicioActividadFactory<IServicioSapPesaNetoService>> factory;
        private Mock<IServicioSapPesaNetoService> contract;
        ...
        public void SetUp()
        {
            factory = new Mock<IServicioActividadFactory<IServicioSapPesaNetoService>>();
            contract = new Mock<IServicioSapPesaNetoService>();
            ...
            contract.Setup(
                s => s.ServicioSapPesaNeto(It.IsAny<Guid>(), It.IsAny<bool>(), It.IsAny<ControlRecorridoDto>()))
                    .Returns(new Resultado());
            target = new ServicioSapPesaNetoController(log, factory.Object, servRepositorio.Object);
