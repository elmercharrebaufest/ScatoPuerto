...
namespace Molinos.Scato.Test.Controllers
{
    ...
    [TestFixture]
    public class CargarOrdenDeDescargaFasonControllerTest
    {
        private CargarOrdenDeDescargaFasonController target;
        private Mock<IServicioRepositorio> servRepositorioMock;
        private Mock<IServicioComandos> servComandosMock;
        private Mock<IServicioActividadFactory<ICargarOrdenDeDescargaFasonService>> actFactoryMock;
        private Mock<ICargarOrdenDeDescargaFasonService> contractMock;
        ...
        public void SetUp()
        {
            ...
            actFactoryMock = new Mock<IServicioActividadFactory<ICargarOrdenDeDescargaFasonService>>();
            contractMock = new Mock<ICargarOrdenDeDescargaFasonService>();
            listaMock = new Mock<IListaDeWorkflows>();
            logger = new NullLogger();
            target = new CargarOrdenDeDescargaFasonController(logger, servRepositorioMock.Object, actFactoryMock.Object, servComandosMock.Object, listaMock.Object);

            dto = new OrdenDeDescargaFasonDto()
            {
                Numero = "77777777",
                FechaOD = DateTime.Now.AddDays(2),
            ...
            contractMock.Setup(s => s.CargarOrdenDeDescargaFason(It.IsAny<OrdenDeDescargaFasonDto>(), It.IsAny<int>(), workflow, It.IsAny<int>(), It.IsAny<string>(), It.IsAny<ControlRecorridoDto>())).Returns(new ResultadoCrearWorkflow { InstanciaWorkflowId = InstanciaWfId }); 
        }
        ...
        [Test]
        public void TestChoferNoSeleccionadoNuevo()
        {
        ...
        [Test]
        public void TestOrdeDeDescargaFasonPorNumeroDeOrdenYClienteExistente()
        {
            servRepositorioMock.Setup(s => s.ObtenerOrdenDeDescargaFasonPorNumeroDeOrdenYCliente(It.IsAny<string>(), It.IsAny<int>()))
               .Returns(new OrdenDeDescargaFasonDto { Id = 1 });
