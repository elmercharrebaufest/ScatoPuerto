...
namespace Molinos.Scato.Test.Servicios
{
    ...
    public class ServicioRepositorioTest
    {
        ...
        public void SetUp()
        {
            ...
            target = new ServicioRepositorio(repositorioMock.Object, conversor, new NullLogger(), firmaMock.Object, calculadora.Object, config.Object, orquestador.Object);
        }
        ...
        public void ObtenerCartaDePorteRegistradaServicioMonsantoVehiculoCamion()
        {
            ...
            repositorioMock.Setup(
                s =>
                s.Obtener<CartaDePorteRegistradaServicioMonsantoDto>(
                    It.IsAny<Expression<Func<CartaDePorteRegistradaServicioMonsanto, bool>>>()))
                           .Returns(new CartaDePorteRegistradaServicioMonsantoDto
                           {
                               Id = 1,
                               LaboratorioRazonSocial = "Lab"
                           });
            target = new ServicioRepositorio(repositorioMock.Object, conversor, new NullLogger(), firmaMock.Object, calculadora.Object, null, orquestador.Object);
        ...
        public void ObtenerCartaDePorteRegistradaServicioMonsantoVehiculoOtro()
        {
            ...
            target = new ServicioRepositorio(repositorioMock.Object, convert.Object, new NullLogger(), firmaMock.Object, null, null, null);
        ...
        public void ObtenerHumedimetroPorNombrePc()
        {
            ...
            repositorioMock.Setup(s => s.Obtener<HumedimetroDto>(It.IsAny<Expression<Func<Humedimetro, bool>>>()))
                           .Returns(new HumedimetroDto { CentroId = 1, Codigo = "H" });
            target = new ServicioRepositorio(repositorioMock.Object, conversor, new NullLogger(), firmaMock.Object, calculadora.Object, null, null);
        ...
        public void ObtenerCartaPorteRedespachoPorNumero()
        {
            ...
            var result = target.ObtenerCartaPorteRedespachoPorNumero("123", 1, "workflow");
