...
namespace Molinos.Scato.WfEditorWeb.ViewModel
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel(IServicioWorkflows servicioWorkflows, ILogger log, string ambiente, string dominio)
        {
            ...
            var login = new LoginWindow(Titulo, dominio);
            login.Topmost = true;
            login.ShowDialog();

            try
            {
                if (UsuarioEditor.UsuarioActual == null || !this.servicioWorkflows.TienePermisoEditordeWorkflow(UsuarioEditor.UsuarioActual))
                {
            ...
            catch (Exception e)
            {
                ...
                MessageBox.Show(Resources.PermisosError + " Codigo: 803", Resources.ErrorMensaje, MessageBoxButton.OK, MessageBoxImage.Warning);
