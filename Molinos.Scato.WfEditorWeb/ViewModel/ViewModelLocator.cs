...
namespace Molinos.Scato.WfEditorWeb.ViewModel
{
    ...
    {      
        ...
        public ViewModelLocator()
        {
            ...
            if (ambiente == "-Embedding")
            {
                ambiente = "";//debug local
            }
            ...
            var svcWorkflow = new ChannelFactory<IServicioWorkflows>("ServicioWorkflows" + ambiente).CreateChannel();

            kernel.Bind<IServicioWorkflows>()
            .ToMethod(context => svcWorkflow);
