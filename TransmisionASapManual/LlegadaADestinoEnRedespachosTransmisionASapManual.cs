...
{
    public class LlegadaADestinoEnRedespachosTransmisionASapManual
    {
        ...
        public static void Ejecutar(string path, IServicioRepositorio srvRepositorio, IServicioComandos servicioComandos)
        {
            ...
            if (File.Exists(path))
            {
                ...
                foreach (var r in listaRecorridos)
                {
                    ...
                    if(recorrido != null)
                    {
                        var t = ObtenerLlegadaADestinoenRedespacho(recorrido.Id, conversor,srvRepositorio,servicioComandos);
        ...
        private static LlegadaAdestinosEnRedespachosTransmisionASap ObtenerLlegadaADestinoenRedespacho(int recorridoId, ConversorAutoMapper conversor, IServicioRepositorio srvRepositorio, IServicioComandos servicioComandos)
        {
