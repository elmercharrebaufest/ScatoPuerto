...
{
    [Autorizacion(PermisosScato.ActividadSalidaDeCentro)]
    public class SalidaDeCentroController : BaseController
    {
        private readonly IServicioActividadFactory<IEjecutarService> factory;
        private readonly ILogger log;

        public SalidaDeCentroController(ILogger log, IServicioActividadFactory<IEjecutarService> factory, IServicioRepositorio servicio)
            : base(servicio)
        {
