...
namespace Molinos.Scato.Web.Controllers
{
    ...
    public class IngresarCartaPorteRedespachoController : CargarCartaPorteController
    {
        ...
        [DatosUsuario]
        public JsonResult ObtenerCartaPorteRedespacho(string numero, string workflow, bool esIngreso, DatosUsuario datosUsuario)
        {
            try
            {
                if (!esIngreso)
                ...
                var cartaPorteResponse = servicio.ObtenerCartaPorteRedespachoPorNumero(numero, datosUsuario.CentroId, workflow);
