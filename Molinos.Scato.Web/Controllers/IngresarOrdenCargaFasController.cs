...
namespace Molinos.Scato.Web.Controllers
{
    ...
    public class IngresarOrdenCargaFasController : DocumentoIngresoController
    {
        ...
        [HttpPost]
        [DatosUsuario]
        public ActionResult Index(string workflow, OrdenCargaFasDto orden, DatosUsuario datosUsuario)
        {
            var workflowObj = servicio.ObtenerWorkflowPorCodigo(workflow);
        ...
        public JsonResult ObtenerDatos(string numero, DatosUsuario datosUsuario)
        {
            ...
            try
            {
                ...
                log.Info("Respuesta: " + respuestaConsultaOrdenCarga.ConsultaOrdenDeCargaResponse.Salida);
