...
namespace Molinos.Scato.Web.Controllers
{
    ...
    public class CoordinacionController : BaseController
    {
        ...
        public CoordinacionController(ILogger log, IServicioRepositorio servicio,IServicioActividadFactory<ICoordinacionService> factory, IConfiguracionProvider configuracion)
            : base(servicio)
        {
            this.log = log;
