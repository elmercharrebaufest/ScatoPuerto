...
namespace Molinos.Scato.Web.Controllers
{
    ...
    public class AutorizarDescuentosEntregadorController : BaseController
    {
        ...
        public AutorizarDescuentosEntregadorController(ILogger log, IServicioRepositorio servicio, IServicioActividadFactory<IAutorizarDescuentosEntregadorService> factory)
            : base(servicio)
        {
            this.log = log;
