...
{
    [Autorizacion(PermisosScato.ActividadCargarCartaPortePrestamo)]
    public class CargarCartaPortePrestamoController : CargarCartaPorteController
    {

        public CargarCartaPortePrestamoController(ILogger log, IServicioRepositorio servicio, IServicioActividadFactory<ICargarCartaPorteService> factory, IServicioComandos servicioComandos, IListaDeWorkflows workflows, IFirmaProvider configuracion, ZSDWS_SCATO servicioSap, IServicioOrquestador servicioOrquestador)
        ...
        {
            return base.Index(workflow, datosUsuario, configuracion.ObtenerFirmaSinLogo().CodigoSAP,"", "", "", cargaDeCupoId);
        }
        ...
        protected override ControlRecorridoDto GenerarControlRecorrido(DatosUsuario usuario)
        {
            ...
            {
                Actividad = Textos.ActCargarCartaPortePrestamo,
                ActividadXaml = "CargarCartaPortePrestamo",
