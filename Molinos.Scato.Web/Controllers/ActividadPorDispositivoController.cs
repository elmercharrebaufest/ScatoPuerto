...
namespace Molinos.Scato.Web.Controllers
{
    ...
    public class ActividadPorDispositivoController : BaseController
    {
        ...
        [HttpPost]
        [DatosUsuario]
        public ActionResult Crear(ActividadPorDispositivoDto model, string salidas, string videoCamarasJson, DatosUsuario datosUsuario)
        {
            if (!string.IsNullOrEmpty(videoCamarasJson))
            {
                model.VideoCamaras = videoCamarasJson.FromJson<VideoCamaraDto[]>().ToList();
            }
            if (ModelState.IsValid && salidas != "")
            {
        ...
        [HttpPost]
        [DatosUsuario]
        public ActionResult Modificar(ActividadPorDispositivoDto model, string salidas, string videoCamarasJson, DatosUsuario datosUsuario)
        {
            if (!string.IsNullOrEmpty(videoCamarasJson))
            {
                model.VideoCamaras = videoCamarasJson.FromJson<VideoCamaraDto[]>().ToList();
