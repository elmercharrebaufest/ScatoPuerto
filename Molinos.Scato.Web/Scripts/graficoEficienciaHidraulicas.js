...
function GraficoEficienciaHidraulicaViewModel() {
    ...
    self.generarGrafico = function () {
        ...
        self.fechaDesdeSeleccionada = $("#FechaDesdeCamiones").val();
        self.fechaHastaSeleccionada = $("#FechaHastaCamiones").val();
        $('#errorSummaryCamiones').html('');

        if (!self.materialSeleccionado || $("#materialDescripcionHidraulica").val() == '') {
    ...
    self.mostrarErrorObligatorio = function (campo) {
        $('#errorSummaryCamiones').html('* El campo ' + campo + ' es obligatorio.');
    }
...
$(document).ready(function () {
    $("#FechaDesdeCamiones").datetimepicker({
        format: "dd/mm/yyyy hh:ii",
        autoclose: true,
        pickerPosition: "bottom-left",
    });
    $("#FechaHastaCamiones").datetimepicker({
        format: "dd/mm/yyyy hh:ii",
        autoclose: true,
        pickerPosition: "bottom-left",
    });
