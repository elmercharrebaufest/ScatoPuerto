...
function mostrarCreditos() {
    $.showCredits({
        ...
        version: '9',
        fecha: '22/05/2018',
        sdl: 'Leonel Magallanes',
        analista: 'Claudio Paz',
        tel: 'Alejandro Olivera',
        desarrolladores: 'Claudio Palacios, Damian Sanchez,Jose Soto, Miguel Benedit, Marcos Parisi',
        testers: 'Alan Modena, Dante Orlandelli',
        logoBaufest: '/Scato.web/Content/images/icon-baufest.png',
        logoCliente: '/Firma/Logo',
        liderCliente: 'Miguel Sarri',
        analistaCliente: 'Alejandro Vozella, Patricio Manna'
    });
}
