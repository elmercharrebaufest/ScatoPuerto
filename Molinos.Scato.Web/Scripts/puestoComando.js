...
function cargarDialogoRechazar(data) {
    ...
    function CargarGrilla(callback) {
        ...
        var columnas = checkCalidad + checkCentroId + checkCuit + checkMaterial + checkTipoDocumentoIngreso + checkNumeroDocumentoIngreso
            + checkPatente + checkProximaEtapa + checkTransportista + checkWorkflow + checkfechaCreacion + checkFechaUltimaModificacion + checkTipoComercial + checkCentro + checkMaterialId + checkTipoVehiculo + checkHumedad;
