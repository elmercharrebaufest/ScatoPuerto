...
function LlenarDatos(datos) {
    if (datos) {
        ...
        if (datos.Chofer) {
            $('#Chofer.Id').val(datos.Chofer.Id);
            $('#Chofer.Nombre').val(datos.Chofer.Nombre);
            $('#Chofer.Apellido').val(datos.Chofer.Apellido);
            $('#Chofer.TipoDocumentoIdentidadId').val(datos.Chofer.TipoDocumentoIdentidadId);
            $('#Chofer.NumeroDeDocumento').val(datos.Chofer.NumeroDeDocumento);
            $('#Chofer.Cuil').val(datos.Chofer.Cuil);
        } else {
            $("input[name^='Chofer']").removeAttr("disabled");
            $("select[name^='Chofer']").removeAttr("disabled");
        }
