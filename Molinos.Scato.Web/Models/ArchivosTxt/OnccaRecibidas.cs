...
namespace Molinos.Scato.Web.Models.ArchivosTxt
{
    public class OnccaRecibidas
    {
        ...
        [TxtColumna(Order = 31, Longitud = 8)]
        public string FechaDeArriboADestino { get; set; }
        [TxtColumna(Order = 32, Longitud = 11)]
        public decimal PesoNetoDeDescarga { get; set; }
        [TxtColumna(Order = 33, Longitud = 11)]
        public long CuitEstablecimientoRedestino { get; set; }
        [TxtColumna(Order = 34, Longitud = 5)]
        public int CodigoDeLocalidadDeRedestino { get; set; }
        [TxtColumna(Order = 35, Longitud = 6)]
        public int CodigoDeEstablecimientoDeRedestino { get; set; }
        [TxtColumna(Order = 36, Longitud = 8)]
