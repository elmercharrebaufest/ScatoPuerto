...
{
    public class ProcesadorImprimirResumenHojaDeRuta : ProcesadorComando<ImprimirResumenHojaDeRuta>
    {
        public ProcesadorImprimirResumenHojaDeRuta(ILogger log)
            : base(log)
        {
        }

        public override Resultado Ejecutar(ImprimirResumenHojaDeRuta comando)
        {
            ...
            try
            {
                ...
                var impresora = new ResumenHojaDeRuta(comando.Dto, comando.Dto.Impresora);
                impresora.Print();
            }
            catch (Exception e)
            {
