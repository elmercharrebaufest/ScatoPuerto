...
{
    public class EtiquetaIntacta : DocumentoImpresion
    {
        private ImpEtiquetaIntactaDto parametros;

        public EtiquetaIntacta(ImpEtiquetaIntactaDto parametros, string printerName)
        {
        ...
        public string GenerarZpl()
        {
            return "^XA~TA000~JSN^LT0^MNW^MTT^PON^PMN^LH0,0^JMA^PR6,6~SD15\r\n^JUS^LRN^CI0^XZ\r\n^XA\r\n^MMT\r\n^PW625\r\n^LL0406\r\n^LS0\r\n^FO0,395^GB620,0,5^FS\r\n^FO0,133^GB620,0,5^FS\r\n^FO0,10^GB620,0,5^FS\r\n^FO0,10^GB0,390,5^FS\r\n^FO620,10^GB0,390,5^FS\r\n^FT90,50^A0N,28,28^FH\\^FDAnalisis de Tecnologia - " +
                ...
                "^FS\r\n^FT66,392^A0N,25,24^FH\\^FDLaboratorio: " + parametros.LaboratiorioCuit + " - " + parametros.LaboratorioNombre +
                "^FS\r\n^FT66,353^A0N,28,28^FH\\^FDTipo de Analisis: " + parametros.TipoDeAnalisis + "^FS\r\n^FT66,310^A0N,56,55^FH\\^FD" + parametros.NumeroCartaPorte +
                "^FS\r\n^PQ1,0,1,Y^XZ\r\n";
        }
        ...
        {
            parametros = (ImpEtiquetaIntactaDto)dto;
